...
let productions = Map [-25,["symbols";"symbols";"symbol"];-24,["symbols";"symbol"];-23,["symbol";"QUOTE"];-22,["symbol";"ID"];-21,["rules";"rules";"rule"];-20,["rules";"rule"];-19,["rule";"ID";":";"bodies"];-18,["precedences";"precedences";"precedence"];-17,["precedences";"precedence"];-16,["precedence";"assoc";"symbols"];-15,["file";"HEADER";"rules";"%%";"precedences";"%%";"declarations"];-14,["file";"HEADER";"rules";"%%";"precedences"];-13,["file";"HEADER";"rules";"%%";"declarations"];-12,["file";"HEADER";"rules"];-11,["declarations";"declarations";"declaration"];-10,["declarations";"declaration"];-9,["declaration";"symbol";":";"QUOTE"];-8,["body";"symbols";"SEMANTIC"];-7,["body";"symbols";"%prec";"ID";"SEMANTIC"];-6,["body";"SEMANTIC"];-5,["bodies";"body"];-4,["bodies";"bodies";"|";"body"];-3,["assoc";"%right"];-2,["assoc";"%nonassoc"];-1,["assoc";"%left"];0,["";"file"]]
let actions = Map [0,Map ["HEADER",22;"file",1];1,Map ["",0];2,Map ["ID",-1;"QUOTE",-1];3,Map ["ID",-2;"QUOTE",-2];4,Map ["ID",-3;"QUOTE",-3];5,Map ["",-19;"%%",-19;"ID",-19;"|",6];6,Map ["ID",35;"QUOTE",36;"SEMANTIC",9;"body",7;"symbol",37;"symbols",10];7,Map ["",-4;"%%",-4;"ID",-4;"|",-4];8,Map ["",-5;"%%",-5;"ID",-5;"|",-5];9,Map ["",-6;"%%",-6;"ID",-6;"|",-6];10,Map ["%prec",11;"ID",35;"QUOTE",36;"SEMANTIC",14;"symbol",38];11,Map ["ID",12];12,Map ["SEMANTIC",13];13,Map ["",-7;"%%",-7;"ID",-7;"|",-7];14,Map ["",-8;"%%",-8;"ID",-8;"|",-8];15,Map [":",16];16,Map ["QUOTE",17];17,Map ["",-9;"ID",-9;"QUOTE",-9];18,Map ["",-10;"ID",-10;"QUOTE",-10];19,Map ["",-13;"ID",35;"QUOTE",36;"declaration",21;"symbol",15];20,Map ["",-15;"ID",35;"QUOTE",36;"declaration",21;"symbol",15];21,Map ["",-11;"ID",-11;"QUOTE",-11];22,Map ["ID",31;"rule",33;"rules",23];23,Map ["",-12;"%%",24;"ID",31;"rule",34];24,Map ["%left",2;"%nonassoc",3;"%right",4;"ID",35;"QUOTE",36;"assoc",27;"declaration",18;"declarations",19;"precedence",29;"precedences",25;"symbol",15];25,Map ["",-14;"%%",26;"%left",2;"%nonassoc",3;"%right",4;"assoc",27;"precedence",30];26,Map ["ID",35;"QUOTE",36;"declaration",18;"declarations",20;"symbol",15];27,Map ["ID",35;"QUOTE",36;"symbol",37;"symbols",28];28,Map ["",-16;"%%",-16;"%left",-16;"%nonassoc",-16;"%right",-16;"ID",35;"QUOTE",36;"symbol",38];29,Map ["",-17;"%%",-17;"%left",-17;"%nonassoc",-17;"%right",-17];30,Map ["",-18;"%%",-18;"%left",-18;"%nonassoc",-18;"%right",-18];31,Map [":",32];32,Map ["ID",35;"QUOTE",36;"SEMANTIC",9;"bodies",5;"body",8;"symbol",37;"symbols",10];33,Map ["",-20;"%%",-20;"ID",-20];34,Map ["",-21;"%%",-21;"ID",-21];35,Map ["",-22;"%%",-22;"%left",-22;"%nonassoc",-22;"%prec",-22;"%right",-22;":",-22;"ID",-22;"QUOTE",-22;"SEMANTIC",-22];36,Map ["",-23;"%%",-23;"%left",-23;"%nonassoc",-23;"%prec",-23;"%right",-23;":",-23;"ID",-23;"QUOTE",-23;"SEMANTIC",-23];37,Map ["",-24;"%%",-24;"%left",-24;"%nonassoc",-24;"%prec",-24;"%right",-24;"ID",-24;"QUOTE",-24;"SEMANTIC",-24];38,Map ["",-25;"%%",-25;"%left",-25;"%nonassoc",-25;"%prec",-25;"%right",-25;"ID",-25;"QUOTE",-25;"SEMANTIC",-25]]
let kernelSymbols = Map [1,"file";2,"%left";3,"%nonassoc";4,"%right";5,"bodies";6,"|";7,"body";8,"body";9,"SEMANTIC";10,"symbols";11,"%prec";12,"ID";13,"SEMANTIC";14,"SEMANTIC";15,"symbol";16,":";17,"QUOTE";18,"declaration";19,"declarations";20,"declarations";21,"declaration";22,"HEADER";23,"rules";24,"%%";25,"precedences";26,"%%";27,"assoc";28,"symbols";29,"precedence";30,"precedence";31,"ID";32,":";33,"rule";34,"rule";35,"ID";36,"QUOTE";37,"symbol";38,"symbol"]
let semantics = Map [-25,"s1::s0";-24,"[s0]";-23,"s0";-22,"s0";-21,"s1::s0";-20,"[s0]";-19,"s0,List.rev s2";-18,"s1::s0";-17,"[s0]";-16,"s0,List.rev s1";-15,"s0, List.rev s1,List.rev s3,List.rev s5";-14,"s0, List.rev s1,List.rev s3,[]";-13,"s0, List.rev s1,[],List.rev s3";-12,"s0, List.rev s1,[],[]";-11,"s1::s0";-10,"[s0]";-9,"s0,s2";-8,"List.rev s0,\"\",s1";-7,"List.rev s0,s2,s3";-6,"[],\"\",s0";-5,"[s0]";-4,"s2::s0";-3,"\"right\"";-2,"\"nonassoc\"";-1,"\"left\""]
