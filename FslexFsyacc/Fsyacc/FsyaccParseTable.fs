...
let actions = Map [0,Map ["HEADER",22;"file",1];1,Map ["",0];2,Map ["ID",-1;"QUOTE",-1];3,Map ["ID",-2;"QUOTE",-2];4,Map ["ID",-3;"QUOTE",-3];5,Map ["",-19;"%%",-19;"ID",-19;"|",6];6,Map ["ID",37;"QUOTE",38;"SEMANTIC",9;"body",7;"symbol",39;"symbols",10];7,Map ["",-4;"%%",-4;"ID",-4;"|",-4];8,Map ["",-5;"%%",-5;"ID",-5;"|",-5];9,Map ["",-6;"%%",-6;"ID",-6;"|",-6];10,Map ["%prec",11;"ID",37;"QUOTE",38;"SEMANTIC",14;"symbol",40];11,Map ["ID",12];12,Map ["SEMANTIC",13];13,Map ["",-7;"%%",-7;"ID",-7;"|",-7];14,Map ["",-8;"%%",-8;"ID",-8;"|",-8];15,Map [":",16];16,Map ["QUOTE",17];17,Map ["",-9;"ID",-9;"QUOTE",-9];18,Map ["",-10;"ID",-10;"QUOTE",-10];19,Map ["",-13;"ID",37;"QUOTE",38;"declaration",21;"symbol",15];20,Map ["",-15;"ID",37;"QUOTE",38;"declaration",21;"symbol",15];21,Map ["",-11;"ID",-11;"QUOTE",-11];22,Map ["ID",31;"rule",33;"rules",23];23,Map ["",-12;"%%",24;"ID",31;"rule",34];24,Map ["%left",2;"%nonassoc",3;"%right",4;"ID",37;"QUOTE",38;"assoc",27;"declaration",18;"declarations",19;"precedence",29;"precedences",25;"symbol",15];25,Map ["",-14;"%%",26;"%left",2;"%nonassoc",3;"%right",4;"assoc",27;"precedence",30];26,Map ["ID",37;"QUOTE",38;"declaration",18;"declarations",20;"symbol",15];27,Map ["ID",37;"QUOTE",38;"symbol",39;"symbols",28];28,Map ["",-16;"%%",-16;"%left",-16;"%nonassoc",-16;"%right",-16;"ID",37;"QUOTE",38;"symbol",40];29,Map ["",-17;"%%",-17;"%left",-17;"%nonassoc",-17;"%right",-17];30,Map ["",-18;"%%",-18;"%left",-18;"%nonassoc",-18;"%right",-18];31,Map [":",35;"sep",32];32,Map ["ID",37;"QUOTE",38;"SEMANTIC",9;"bodies",5;"body",8;"symbol",39;"symbols",10];33,Map ["",-20;"%%",-20;"ID",-20];34,Map ["",-21;"%%",-21;"ID",-21];35,Map ["ID",-22;"QUOTE",-22;"SEMANTIC",-22;"|",36];36,Map ["ID",-23;"QUOTE",-23;"SEMANTIC",-23];37,Map ["",-24;"%%",-24;"%left",-24;"%nonassoc",-24;"%prec",-24;"%right",-24;":",-24;"ID",-24;"QUOTE",-24;"SEMANTIC",-24];38,Map ["",-25;"%%",-25;"%left",-25;"%nonassoc",-25;"%prec",-25;"%right",-25;":",-25;"ID",-25;"QUOTE",-25;"SEMANTIC",-25];39,Map ["",-26;"%%",-26;"%left",-26;"%nonassoc",-26;"%prec",-26;"%right",-26;"ID",-26;"QUOTE",-26;"SEMANTIC",-26];40,Map ["",-27;"%%",-27;"%left",-27;"%nonassoc",-27;"%prec",-27;"%right",-27;"ID",-27;"QUOTE",-27;"SEMANTIC",-27]]
...
let semantics = Map [-27,"s1::s0";-26,"[s0]";-25,"s0";-24,"s0";-23,"0";-22,"0";-21,"s1::s0";-20,"[s0]";-19,"s0,List.rev s2";-18,"s1::s0";-17,"[s0]";-16,"s0,List.rev s1";-15,"s0, List.rev s1,List.rev s3,List.rev s5";-14,"s0, List.rev s1,List.rev s3,[]";-13,"s0, List.rev s1,[],List.rev s3";-12,"s0, List.rev s1,[],[]";-11,"s1::s0";-10,"[s0]";-9,"s0,s2";-8,"List.rev s0,\"\",s1";-7,"List.rev s0,s2,s3";-6,"[],\"\",s0";-5,"[s0]";-4,"s2::s0";-3,"\"right\"";-2,"\"nonassoc\"";-1,"\"left\""]
let declarations = ["HEADER","string";"ID","string";"QUOTE","string";"SEMANTIC","string";"assoc","string";"bodies","(string list*string*string)list";"body","string list*string*string";"declaration","string*string";"declarations","(string*string)list";"file","string*(string*((string list*string*string)list))list*(string*string list)list*(string*string)list";"precedence","string*string list";"precedences","(string*string list)list";"rule","string*((string list*string*string)list)";"rules","(string*((string list*string*string)list))list";"symbol","string";"symbols","string list";"sep","int"]
