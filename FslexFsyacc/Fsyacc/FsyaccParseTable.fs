...
let actions = Map [0,Map ["HEADER",22;"file",1];1,Map ["",0];2,Map ["IDENTIFIER",-1;"QUOTE",-1];3,Map ["IDENTIFIER",-2;"QUOTE",-2];4,Map ["IDENTIFIER",-3;"QUOTE",-3];5,Map ["",-19;"%%",-19;"IDENTIFIER",-19;"|",6];6,Map ["IDENTIFIER",35;"QUOTE",36;"SEMANTIC",9;"body",7;"symbol",37;"symbols",10];7,Map ["",-4;"%%",-4;"IDENTIFIER",-4;"|",-4];8,Map ["",-5;"%%",-5;"IDENTIFIER",-5;"|",-5];9,Map ["",-6;"%%",-6;"IDENTIFIER",-6;"|",-6];10,Map ["%prec",11;"IDENTIFIER",35;"QUOTE",36;"SEMANTIC",14;"symbol",38];11,Map ["IDENTIFIER",12];12,Map ["SEMANTIC",13];13,Map ["",-7;"%%",-7;"IDENTIFIER",-7;"|",-7];14,Map ["",-8;"%%",-8;"IDENTIFIER",-8;"|",-8];15,Map [":",16];16,Map ["QUOTE",17];17,Map ["",-9;"IDENTIFIER",-9;"QUOTE",-9];18,Map ["",-10;"IDENTIFIER",-10;"QUOTE",-10];19,Map ["",-13;"IDENTIFIER",35;"QUOTE",36;"declaration",21;"symbol",15];20,Map ["",-15;"IDENTIFIER",35;"QUOTE",36;"declaration",21;"symbol",15];21,Map ["",-11;"IDENTIFIER",-11;"QUOTE",-11];22,Map ["IDENTIFIER",31;"rule",33;"rules",23];23,Map ["",-12;"%%",24;"IDENTIFIER",31;"rule",34];24,Map ["%left",2;"%nonassoc",3;"%right",4;"IDENTIFIER",35;"QUOTE",36;"assoc",27;"declaration",18;"declarations",19;"precedence",29;"precedences",25;"symbol",15];25,Map ["",-14;"%%",26;"%left",2;"%nonassoc",3;"%right",4;"assoc",27;"precedence",30];26,Map ["IDENTIFIER",35;"QUOTE",36;"declaration",18;"declarations",20;"symbol",15];27,Map ["IDENTIFIER",35;"QUOTE",36;"symbol",37;"symbols",28];28,Map ["",-16;"%%",-16;"%left",-16;"%nonassoc",-16;"%right",-16;"IDENTIFIER",35;"QUOTE",36;"symbol",38];29,Map ["",-17;"%%",-17;"%left",-17;"%nonassoc",-17;"%right",-17];30,Map ["",-18;"%%",-18;"%left",-18;"%nonassoc",-18;"%right",-18];31,Map [":",32];32,Map ["IDENTIFIER",35;"QUOTE",36;"SEMANTIC",9;"bodies",5;"body",8;"symbol",37;"symbols",10];33,Map ["",-20;"%%",-20;"IDENTIFIER",-20];34,Map ["",-21;"%%",-21;"IDENTIFIER",-21];35,Map ["",-22;"%%",-22;"%left",-22;"%nonassoc",-22;"%prec",-22;"%right",-22;":",-22;"IDENTIFIER",-22;"QUOTE",-22;"SEMANTIC",-22];36,Map ["",-23;"%%",-23;"%left",-23;"%nonassoc",-23;"%prec",-23;"%right",-23;":",-23;"IDENTIFIER",-23;"QUOTE",-23;"SEMANTIC",-23];37,Map ["",-24;"%%",-24;"%left",-24;"%nonassoc",-24;"%prec",-24;"%right",-24;"IDENTIFIER",-24;"QUOTE",-24;"SEMANTIC",-24];38,Map ["",-25;"%%",-25;"%left",-25;"%nonassoc",-25;"%prec",-25;"%right",-25;"IDENTIFIER",-25;"QUOTE",-25;"SEMANTIC",-25]]
let kernelSymbols = Map [1,"file";2,"%left";3,"%nonassoc";4,"%right";5,"bodies";6,"|";7,"body";8,"body";9,"SEMANTIC";10,"symbols";11,"%prec";12,"IDENTIFIER";13,"SEMANTIC";14,"SEMANTIC";15,"symbol";16,":";17,"QUOTE";18,"declaration";19,"declarations";20,"declarations";21,"declaration";22,"HEADER";23,"rules";24,"%%";25,"precedences";26,"%%";27,"assoc";28,"symbols";29,"precedence";30,"precedence";31,"IDENTIFIER";32,":";33,"rule";34,"rule";35,"IDENTIFIER";36,"QUOTE";37,"symbol";38,"symbol"]
