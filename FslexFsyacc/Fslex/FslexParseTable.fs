...
let actions = [["HEADER",24;"file",1];["",0];["%%",-1;"&",-1;")",-1;"*",-1;"+",-1;"/",-1;"?",-1;"CAP",-1;"SEMANTIC",-1;"]",-1;"|",-1];["%%",-2;"&",-2;")",-2;"*",-2;"+",-2;"/",-2;"?",-2;"CAP",-2;"SEMANTIC",-2;"]",-2;"|",-2];["=",5];["(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",6];["%%",-3;"&",19;"*",20;"+",21;"?",22;"CAP",-3;"|",23];["(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",8];["&",19;")",9;"*",20;"+",21;"?",22;"|",23];["%%",-4;"&",-4;")",-4;"*",-4;"+",-4;"/",-4;"?",-4;"CAP",-4;"SEMANTIC",-4;"|",-4];["%%",-5;"&",-5;")",-5;"*",-5;"+",-5;"/",-5;"?",-5;"CAP",-5;"SEMANTIC",-5;"|",-5];["ID",2;"LITERAL",3;"character",32;"{character+}",12];["&",33;"]",13];["%%",-6;"&",-6;")",-6;"*",-6;"+",-6;"/",-6;"?",-6;"CAP",-6;"SEMANTIC",-6;"|",-6];["%%",-7;"&",-7;")",-7;"*",-7;"+",-7;"/",-7;"?",-7;"CAP",-7;"SEMANTIC",-7;"|",-7];["%%",-8;"&",-8;")",-8;"*",20;"+",21;"/",-8;"?",22;"CAP",-8;"SEMANTIC",-8;"|",-8];["%%",-12;"&",19;")",-12;"*",20;"+",21;"/",-12;"?",22;"CAP",-12;"SEMANTIC",-12;"|",-12];["&",19;"*",20;"+",21;"/",29;"?",22;"SEMANTIC",31;"|",23];["&",19;"*",20;"+",21;"?",22;"SEMANTIC",30;"|",23];["(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",15];["%%",-9;"&",-9;")",-9;"*",-9;"+",-9;"/",-9;"?",-9;"CAP",-9;"SEMANTIC",-9;"|",-9];["%%",-10;"&",-10;")",-10;"*",-10;"+",-10;"/",-10;"?",-10;"CAP",-10;"SEMANTIC",-10;"|",-10];["%%",-11;"&",-11;")",-11;"*",-11;"+",-11;"/",-11;"?",-11;"CAP",-11;"SEMANTIC",-11;"|",-11];["(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",16];["(",7;"CAP",4;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"definition",35;"expr",17;"rule",37;"{definition+}",25;"{rule+}",28];["%%",26;"CAP",4;"definition",36];["(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",17;"rule",37;"{rule+}",27];["",-13;"(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",17;"rule",38];["",-14;"(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",17;"rule",38];["(",7;"HOLE",10;"ID",2;"LITERAL",3;"[",11;"character",14;"expr",18];["",-15;"(",-15;"HOLE",-15;"ID",-15;"LITERAL",-15;"[",-15];["",-16;"(",-16;"HOLE",-16;"ID",-16;"LITERAL",-16;"[",-16];["&",-17;"]",-17];["ID",2;"LITERAL",3;"character",34];["&",-18;"]",-18];["%%",-19;"CAP",-19];["%%",-20;"CAP",-20];["",-21;"(",-21;"HOLE",-21;"ID",-21;"LITERAL",-21;"[",-21];["",-22;"(",-22;"HOLE",-22;"ID",-22;"LITERAL",-22;"[",-22]]
...
let rules:(string list*(obj list->obj))list = [
    ...
    ["definition";"CAP";"=";"expr"],fun(ss:obj list)->
        ...
        let result:string*RegularExpression<string> =
            s0,s2
        box result
    ["expr";"character"],fun(ss:obj list)->
    ...
    ["expr";"[";"{character+}";"]"],fun(ss:obj list)->
        ...
        let result:RegularExpression<string> =
            clazz s1
        box result
    ["character";"ID"],fun(ss:obj list)->
        let s0 = unbox<string> ss.[0]
        let result:RegularExpression<string> =
            Character s0
        box result
    ["character";"LITERAL"],fun(ss:obj list)->
        let s0 = unbox<string> ss.[0]
        let result:RegularExpression<string> =
            Character s0
        box result
    ["{character+}";"{character+}";"&";"character"],fun(ss:obj list)->
        let s0 = unbox<RegularExpression<string> list> ss.[0]
        let s2 = unbox<RegularExpression<string>> ss.[2]
        let result:RegularExpression<string> list =
            s2::s0
        box result
    ["{character+}";"character"],fun(ss:obj list)->
        let s0 = unbox<RegularExpression<string>> ss.[0]
        let result:RegularExpression<string> list =
            [s0]
        box result
