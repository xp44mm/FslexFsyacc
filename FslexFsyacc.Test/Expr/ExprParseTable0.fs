module Expr.ExprParseTable0
let rules = [|["expr";"expr";"+";"expr"],"s0 + s2";["expr";"expr";"-";"expr"],"s0 - s2";["expr";"expr";"*";"expr"],"s0 * s2";["expr";"expr";"/";"expr"],"s0 / s2";["expr";"(";"expr";")"],"s1";["expr";"-";"expr"],"-s1";["expr";"NUMBER"],"s0"|]
