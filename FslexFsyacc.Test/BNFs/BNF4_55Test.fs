...
type BNF4_55Test(output: ITestOutputHelper) =
    ...
    member _.``productions``() =
        ...
        Should.equal BNF4_55.productions grammar.productions
    ...
    member _.``kernels``() =
        ...
        Should.equal BNF4_55.kernels row.kernels
    ...
    member _.``closures``() =
        ...
        Should.equal BNF4_55.closures row.closures
    ...
    member _.``actions``() =
        ...
        Should.equal BNF4_55.actions row.actions
