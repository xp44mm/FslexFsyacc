...
The latest version of this specification can be found at [fsharp.org](http://fsharp.org). Many thanks to the F# user community for their helpful feedback on the document so far.
...
- Initial updates for F# 3.1, June 2013 (see [online description of language updates](http://blogs.msdn.com/b/fsharpteam/archive/2013/06/27/announcing-a-pre-release-of-f-3-1-and-the-visual-f-tools-in-visual-studio-2013.aspx))
...
[1.1 A First Program [11](#a-first-program)](#a-first-program)

[1.1.1 Lightweight Syntax [11](#lightweight-syntax)](#lightweight-syntax)

[1.1.2 Making Data Simple [12](#making-data-simple)](#making-data-simple)

[1.1.3 Making Types Simple [13](#making-types-simple)](#making-types-simple)

[1.1.4 Functional Programming [13](#functional-programming)](#functional-programming)

[1.1.5 Imperative Programming [15](#imperative-programming)](#imperative-programming)

[1.1.6 .NET Interoperability and CLI Fidelity [15](#net-interoperability-and-cli-fidelity)](#net-interoperability-and-cli-fidelity)

[1.1.7 Parallel and Asynchronous Programming [15](#parallel-and-asynchronous-programming)](#parallel-and-asynchronous-programming)

[1.1.8 Strong Typing for Floating-Point Code [16](#strong-typing-for-floating-point-code)](#strong-typing-for-floating-point-code)

[1.1.9 Object-Oriented Programming and Code Organization [17](#object-oriented-programming-and-code-organization)](#object-oriented-programming-and-code-organization)

[1.1.10 Information-rich Programming [18](#information-rich-programming)](#information-rich-programming)

[1.2 Notational Conventions in This Specification [19](#notational-conventions-in-this-specification)](#notational-conventions-in-this-specification)

[2. Program Structure [21](#_Toc439782242)](#_Toc439782242)

[3. Lexical Analysis [23](#lexical-analysis)](#lexical-analysis)

[3.1 Whitespace [23](#whitespace)](#whitespace)

[3.2 Comments [23](#comments)](#comments)

[3.3 Conditional Compilation [24](#conditional-compilation)](#conditional-compilation)

[3.4 Identifiers and Keywords [24](#identifiers-and-keywords)](#identifiers-and-keywords)

[3.5 Strings and Characters [26](#strings-and-characters)](#strings-and-characters)

[3.6 Symbolic Keywords [27](#symbolic-keywords)](#symbolic-keywords)

[3.7 Symbolic Operators [28](#symbolic-operators)](#symbolic-operators)

[3.8 Numeric Literals [28](#numeric-literals)](#numeric-literals)

[3.8.1 Post-filtering of Adjacent Prefix Tokens [29](#post-filtering-of-adjacent-prefix-tokens)](#post-filtering-of-adjacent-prefix-tokens)

[3.8.2 Post-filtering of Integers Followed by Adjacent “..” [30](#post-filtering-of-integers-followed-by-adjacent-..)](#post-filtering-of-integers-followed-by-adjacent-..)

[3.8.3 Reserved Numeric Literal Forms [30](#reserved-numeric-literal-forms)](#reserved-numeric-literal-forms)

[3.8.4 Shebang [30](#shebang)](#shebang)

[3.9 Line Directives [30](#line-directives)](#line-directives)

[3.10 Hidden Tokens [30](#hidden-tokens)](#hidden-tokens)

[3.11 Identifier Replacements [31](#identifier-replacements)](#identifier-replacements)

[4. Basic Grammar Elements [33](#basic-grammar-elements)](#basic-grammar-elements)

[4.1 Operator Names [33](#operator-names)](#operator-names)

[4.2 Long Identifiers [35](#long-identifiers)](#long-identifiers)

[4.3 Constants [35](#constants)](#constants)

[4.4 Operators and Precedence [36](#operators-and-precedence)](#operators-and-precedence)

[4.4.1 Categorization of Symbolic Operators [36](#categorization-of-symbolic-operators)](#categorization-of-symbolic-operators)

[4.4.2 Precedence of Symbolic Operators and Pattern/Expression Constructs [37](#precedence-of-symbolic-operators-and-patternexpression-constructs)](#precedence-of-symbolic-operators-and-patternexpression-constructs)

[5. Types and Type Constraints [39](#types-and-type-constraints)](#types-and-type-constraints)

[5.1 Checking Syntactic Types [40](#checking-syntactic-types)](#checking-syntactic-types)

[5.1.1 Named Types [41](#named-types)](#named-types)

[5.1.2 Variable Types [41](#variable-types)](#variable-types)

[5.1.3 Tuple Types [42](#tuple-types)](#tuple-types)

[5.1.4 Array Types [42](#array-types)](#array-types)

[5.1.5 Constrained Types [42](#constrained-types)](#constrained-types)

[5.2 Type Constraints [43](#type-constraints)](#type-constraints)

[5.2.1 Subtype Constraints [43](#subtype-constraints)](#subtype-constraints)

[5.2.2 Nullness Constraints [44](#nullness-constraints)](#nullness-constraints)

[5.2.3 Member Constraints [44](#member-constraints)](#member-constraints)

[5.2.4 Default Constructor Constraints [45](#default-constructor-constraints)](#default-constructor-constraints)

[5.2.5 Value Type Constraints [45](#value-type-constraints)](#value-type-constraints)

[5.2.6 Reference Type Constraints [45](#reference-type-constraints)](#reference-type-constraints)

[5.2.7 Enumeration Constraints [46](#enumeration-constraints)](#enumeration-constraints)

[5.2.8 Delegate Constraints [46](#delegate-constraints)](#delegate-constraints)

[5.2.9 Unmanaged Constraints [46](#unmanaged-constraints)](#unmanaged-constraints)

[5.2.10 Equality and Comparison Constraints [47](#equality-and-comparison-constraints)](#equality-and-comparison-constraints)

[5.3 Type Parameter Definitions [47](#type-parameter-definitions)](#type-parameter-definitions)

[5.4 Logical Properties of Types [48](#logical-properties-of-types)](#logical-properties-of-types)

[5.4.1 Characteristics of Type Definitions [48](#characteristics-of-type-definitions)](#characteristics-of-type-definitions)

[5.4.2 Expanding Abbreviations and Inference Equations [49](#expanding-abbreviations-and-inference-equations)](#expanding-abbreviations-and-inference-equations)

[5.4.3 Type Variables and Definition Sites [50](#type-variables-and-definition-sites)](#type-variables-and-definition-sites)

[5.4.4 Base Type of a Type [51](#base-type-of-a-type)](#base-type-of-a-type)

[5.4.5 Interfaces Types of a Type [51](#interfaces-types-of-a-type)](#interfaces-types-of-a-type)

[5.4.6 Type Equivalence [51](#type-equivalence)](#type-equivalence)

[5.4.7 Subtyping and Coercion [52](#subtyping-and-coercion)](#subtyping-and-coercion)

[5.4.8 Nullness [52](#nullness)](#nullness)

[5.4.9 Default Initialization [53](#default-initialization)](#default-initialization)

[5.4.10 Dynamic Conversion Between Types [53](#dynamic-conversion-between-types)](#dynamic-conversion-between-types)

[6. Expressions [55](#expressions)](#expressions)

[6.1 Some Checking and Inference Terminology [57](#some-checking-and-inference-terminology)](#some-checking-and-inference-terminology)

[6.2 Elaboration and Elaborated Expressions [58](#_Toc439782298)](#_Toc439782298)

[6.3 Data Expressions [59](#data-expressions)](#data-expressions)

[6.3.1 Simple Constant Expressions [60](#simple-constant-expressions)](#simple-constant-expressions)

[6.3.2 Tuple Expressions [61](#tuple-expressions)](#tuple-expressions)

[6.3.3 List Expressions [62](#list-expressions)](#list-expressions)

[6.3.4 Array Expressions [62](#array-expressions)](#array-expressions)

[6.3.5 Record Expressions [62](#record-expressions)](#record-expressions)

[6.3.6 Copy-and-update Record Expressions [64](#copy-and-update-record-expressions)](#copy-and-update-record-expressions)

[6.3.7 Function Expressions [65](#function-expressions)](#function-expressions)

[6.3.8 Object Expressions [65](#object-expressions)](#object-expressions)

[6.3.9 Delayed Expressions [67](#delayed-expressions)](#delayed-expressions)

[6.3.10 Computation Expressions [67](#computation-expressions)](#computation-expressions)

[6.3.11 Sequence Expressions [79](#sequence-expressions)](#sequence-expressions)

[6.3.12 Range Expressions [80](#range-expressions)](#range-expressions)

[6.3.13 Lists via Sequence Expressions [80](#lists-via-sequence-expressions)](#lists-via-sequence-expressions)

[6.3.14 Arrays Sequence Expressions [81](#arrays-sequence-expressions)](#arrays-sequence-expressions)

[6.3.15 Null Expressions [81](#null-expressions)](#null-expressions)

[6.3.16 'printf' Formats [81](#printf-formats)](#printf-formats)

[6.4 Application Expressions [82](#application-expressions)](#application-expressions)

[6.4.1 Basic Application Expressions [82](#basic-application-expressions)](#basic-application-expressions)

[6.4.2 Object Construction Expressions [84](#object-construction-expressions)](#object-construction-expressions)

[6.4.3 Operator Expressions [85](#operator-expressions)](#operator-expressions)

[6.4.4 Dynamic Operator Expressions [86](#dynamic-operator-expressions)](#dynamic-operator-expressions)

[6.4.5 The AddressOf Operators [86](#the-addressof-operators)](#the-addressof-operators)

[6.4.6 Lookup Expressions [87](#lookup-expressions)](#lookup-expressions)

[6.4.7 Slice Expressions [88](#slice-expressions)](#slice-expressions)

[6.4.8 Member Constraint Invocation Expressions [89](#member-constraint-invocation-expressions)](#member-constraint-invocation-expressions)

[6.4.9 Assignment Expressions [90](#assignment-expressions)](#assignment-expressions)

[6.5 Control Flow Expressions [91](#control-flow-expressions)](#control-flow-expressions)

[6.5.1 Parenthesized and Block Expressions [91](#parenthesized-and-block-expressions)](#parenthesized-and-block-expressions)

[6.5.2 Sequential Execution Expressions [91](#sequential-execution-expressions)](#sequential-execution-expressions)

[6.5.3 Conditional Expressions [92](#conditional-expressions)](#conditional-expressions)

[6.5.4 Shortcut Operator Expressions [92](#shortcut-operator-expressions)](#shortcut-operator-expressions)

[6.5.5 Pattern-Matching Expressions and Functions [93](#pattern-matching-expressions-and-functions)](#pattern-matching-expressions-and-functions)

[6.5.6 Sequence Iteration Expressions [93](#sequence-iteration-expressions)](#sequence-iteration-expressions)

[6.5.7 Simple for-Loop Expressions [94](#simple-for-loop-expressions)](#simple-for-loop-expressions)

[6.5.8 While Expressions [95](#while-expressions)](#while-expressions)

[6.5.9 Try-with Expressions [95](#try-with-expressions)](#try-with-expressions)

[6.5.10 Reraise Expressions [95](#reraise-expressions)](#reraise-expressions)

[6.5.11 Try-finally Expressions [96](#try-finally-expressions)](#try-finally-expressions)

[6.5.12 Assertion Expressions [96](#assertion-expressions)](#assertion-expressions)

[6.6 Definition Expressions [96](#definition-expressions)](#definition-expressions)

[6.6.1 Value Definition Expressions [97](#value-definition-expressions)](#value-definition-expressions)

[6.6.2 Function Definition Expressions [98](#function-definition-expressions)](#function-definition-expressions)

[6.6.3 Recursive Definition Expressions [99](#recursive-definition-expressions)](#recursive-definition-expressions)

[6.6.4 Deterministic Disposal Expressions [99](#deterministic-disposal-expressions)](#deterministic-disposal-expressions)

[6.7 Type-Related Expressions [100](#type-related-expressions)](#type-related-expressions)

[6.7.1 Type-Annotated Expressions [100](#type-annotated-expressions)](#type-annotated-expressions)

[6.7.2 Static Coercion Expressions [100](#static-coercion-expressions)](#static-coercion-expressions)

[6.7.3 Dynamic Type-Test Expressions [100](#dynamic-type-test-expressions)](#dynamic-type-test-expressions)

[6.7.4 Dynamic Coercion Expressions [101](#dynamic-coercion-expressions)](#dynamic-coercion-expressions)

[6.8 Quoted Expressions [101](#quoted-expressions)](#quoted-expressions)

[6.8.1 Strongly Typed Quoted Expressions [102](#strongly-typed-quoted-expressions)](#strongly-typed-quoted-expressions)

[6.8.2 Weakly Typed Quoted Expressions [102](#weakly-typed-quoted-expressions)](#weakly-typed-quoted-expressions)

[6.8.3 Expression Splices [103](#expression-splices)](#expression-splices)

[6.9 Evaluation of Elaborated Forms [104](#evaluation-of-elaborated-forms)](#evaluation-of-elaborated-forms)

[6.9.1 Values and Execution Context [104](#_Toc439782354)](#_Toc439782354)

[6.9.2 Parallel Execution and Memory Model [105](#parallel-execution-and-memory-model)](#parallel-execution-and-memory-model)

[6.9.3 Zero Values [106](#zero-values)](#zero-values)

[6.9.4 Taking the Address of an Elaborated Expression [106](#taking-the-address-of-an-elaborated-expression)](#taking-the-address-of-an-elaborated-expression)

[6.9.5 Evaluating Value References [107](#evaluating-value-references)](#evaluating-value-references)

[6.9.6 Evaluating Function Applications [107](#evaluating-function-applications)](#evaluating-function-applications)

[6.9.7 Evaluating Method Applications [107](#evaluating-method-applications)](#evaluating-method-applications)

[6.9.8 Evaluating Union Cases [108](#evaluating-union-cases)](#evaluating-union-cases)

[6.9.9 Evaluating Field Lookups [108](#evaluating-field-lookups)](#evaluating-field-lookups)

[6.9.10 Evaluating Array Expressions [108](#evaluating-array-expressions)](#evaluating-array-expressions)

[6.9.11 Evaluating Record Expressions [108](#evaluating-record-expressions)](#evaluating-record-expressions)

[6.9.12 Evaluating Function Expressions [108](#evaluating-function-expressions)](#evaluating-function-expressions)

[6.9.13 Evaluating Object Expressions [109](#evaluating-object-expressions)](#evaluating-object-expressions)

[6.9.14 Evaluating Definition Expressions [109](#evaluating-definition-expressions)](#evaluating-definition-expressions)

[6.9.15 Evaluating Integer For Loops [109](#evaluating-integer-for-loops)](#evaluating-integer-for-loops)

[6.9.16 Evaluating While Loops [109](#evaluating-while-loops)](#evaluating-while-loops)

[6.9.17 Evaluating Static Coercion Expressions [109](#evaluating-static-coercion-expressions)](#evaluating-static-coercion-expressions)

[6.9.18 Evaluating Dynamic Type-Test Expressions [110](#evaluating-dynamic-type-test-expressions)](#evaluating-dynamic-type-test-expressions)

[6.9.19 Evaluating Dynamic Coercion Expressions [110](#evaluating-dynamic-coercion-expressions)](#evaluating-dynamic-coercion-expressions)

[6.9.20 Evaluating Sequential Execution Expressions [111](#evaluating-sequential-execution-expressions)](#evaluating-sequential-execution-expressions)

[6.9.21 Evaluating Try-with Expressions [111](#evaluating-try-with-expressions)](#evaluating-try-with-expressions)

[6.9.22 Evaluating Try-finally Expressions [111](#evaluating-try-finally-expressions)](#evaluating-try-finally-expressions)

[6.9.23 Evaluating AddressOf Expressions [111](#evaluating-addressof-expressions)](#evaluating-addressof-expressions)

[6.9.24 Values with Underspecified Object Identity and Type Identity [112](#values-with-underspecified-object-identity-and-type-identity)](#values-with-underspecified-object-identity-and-type-identity)

[7. Patterns [115](#patterns)](#patterns)

[7.1 Simple Constant Patterns [116](#simple-constant-patterns)](#simple-constant-patterns)

[7.2 Named Patterns [116](#named-patterns)](#named-patterns)

[7.2.1 Union Case Patterns [117](#union-case-patterns)](#union-case-patterns)

[7.2.2 Literal Patterns [118](#literal-patterns)](#literal-patterns)

[7.2.3 Active Patterns [118](#active-patterns)](#active-patterns)

[7.3 “As” Patterns [120](#as-patterns)](#as-patterns)

[7.4 Wildcard Patterns [120](#wildcard-patterns)](#wildcard-patterns)

[7.5 Disjunctive Patterns [121](#disjunctive-patterns)](#disjunctive-patterns)

[7.6 Conjunctive Patterns [121](#conjunctive-patterns)](#conjunctive-patterns)

[7.7 List Patterns [121](#list-patterns)](#list-patterns)

[7.8 Type-Annotated Patterns [122](#type-annotated-patterns)](#type-annotated-patterns)

[7.9 Dynamic Type-Test Patterns [122](#dynamic-type-test-patterns)](#dynamic-type-test-patterns)

[7.10 Record Patterns [123](#record-patterns)](#record-patterns)

[7.11 Array Patterns [123](#array-patterns)](#array-patterns)

[7.12 Null Patterns [124](#null-patterns)](#null-patterns)

[7.13 Guarded Pattern Rules [124](#guarded-pattern-rules)](#guarded-pattern-rules)

[8. Type Definitions [125](#type-definitions)](#type-definitions)

[8.1 Type Definition Group Checking and Elaboration [128](#type-definition-group-checking-and-elaboration)](#type-definition-group-checking-and-elaboration)

[8.2 Type Kind Inference [131](#type-kind-inference)](#type-kind-inference)

[8.3 Type Abbreviations [132](#type-abbreviations)](#type-abbreviations)

[8.4 Record Type Definitions [133](#record-type-definitions)](#record-type-definitions)

[8.4.1 Members in Record Types [134](#members-in-record-types)](#members-in-record-types)

[8.4.2 Name Resolution and Record Field Labels [134](#name-resolution-and-record-field-labels)](#name-resolution-and-record-field-labels)

[8.4.3 Structural Hashing, Equality, and Comparison for Record Types [134](#structural-hashing-equality-and-comparison-for-record-types)](#structural-hashing-equality-and-comparison-for-record-types)

[8.4.4 With/End in Record Type Definitions [134](#withend-in-record-type-definitions)](#withend-in-record-type-definitions)

[8.4.5 CLIMutable Attributes [134](#climutable-attributes)](#climutable-attributes)

[8.5 Union Type Definitions [135](#union-type-definitions)](#union-type-definitions)

[8.5.1 Members in Union Types [136](#members-in-union-types)](#members-in-union-types)

[8.5.2 Structural Hashing, Equality, and Comparison for Union Types [136](#structural-hashing-equality-and-comparison-for-union-types)](#structural-hashing-equality-and-comparison-for-union-types)

[8.5.3 With/End in Union Type Definitions [136](#withend-in-union-type-definitions)](#withend-in-union-type-definitions)

[8.5.4 Compiled Form of Union Types for Use from Other CLI Languages [137](#compiled-form-of-union-types-for-use-from-other-cli-languages)](#compiled-form-of-union-types-for-use-from-other-cli-languages)

[8.6 Class Type Definitions [137](#class-type-definitions)](#class-type-definitions)

[8.6.1 Primary Constructors in Classes [138](#primary-constructors-in-classes)](#primary-constructors-in-classes)

[8.6.2 Members in Classes [142](#members-in-classes)](#members-in-classes)

[8.6.3 Additional Object Constructors in Classes [142](#additional-object-constructors-in-classes)](#additional-object-constructors-in-classes)

[8.6.4 Additional Fields in Classes [143](#additional-fields-in-classes)](#additional-fields-in-classes)

[8.7 Interface Type Definitions [144](#interface-type-definitions)](#interface-type-definitions)

[8.8 Struct Type Definitions [145](#struct-type-definitions)](#struct-type-definitions)

[8.9 Enum Type Definitions [147](#enum-type-definitions)](#enum-type-definitions)

[8.10 Delegate Type Definitions [148](#delegate-type-definitions)](#delegate-type-definitions)

[8.11 Exception Definitions [148](#exception-definitions)](#exception-definitions)

[8.12 Type Extensions [149](#type-extensions)](#type-extensions)

[8.12.1 Imported CLI C# Extensions Members [151](#imported-cli-c-extensions-members)](#imported-cli-c-extensions-members)

[8.13 Members [152](#members)](#members)

[8.13.1 Property Members [153](#property-members)](#property-members)

[8.13.2 Auto-implemented Properties [154](#auto-implemented-properties)](#auto-implemented-properties)

[8.13.3 Method Members [155](#method-members)](#method-members)

[8.13.4 Curried Method Members [155](#curried-method-members)](#curried-method-members)

[8.13.5 Named Arguments to Method Members [156](#named-arguments-to-method-members)](#named-arguments-to-method-members)

[8.13.6 Optional Arguments to Method Members [157](#optional-arguments-to-method-members)](#optional-arguments-to-method-members)

[8.13.7 Type-directed Conversions at Member Invocations [159](#type-directed-conversions-at-member-invocations)](#type-directed-conversions-at-member-invocations)

[8.13.8 Overloading of Methods [160](#conversion-to-quotation-values)](#conversion-to-quotation-values)

[8.13.9 Naming Restrictions for Members [162](#naming-restrictions-for-members)](#naming-restrictions-for-members)

[8.13.10 Members Represented as Events [162](#members-represented-as-events)](#members-represented-as-events)

[8.13.11 Members Represented as Static Members [163](#members-represented-as-static-members)](#members-represented-as-static-members)

[8.14 Abstract Members and Interface Implementations [164](#abstract-members-and-interface-implementations)](#abstract-members-and-interface-implementations)

[8.14.1 Abstract Members [164](#abstract-members)](#abstract-members)

[8.14.2 Members that Implement Abstract Members [165](#members-that-implement-abstract-members)](#members-that-implement-abstract-members)

[8.14.3 Interface Implementations [167](#interface-implementations)](#interface-implementations)

[8.15 Equality, Hashing, and Comparison [169](#equality-hashing-and-comparison)](#equality-hashing-and-comparison)

[8.15.1 Equality Attributes [170](#equality-attributes)](#equality-attributes)

[8.15.2 Comparison Attributes [170](#comparison-attributes)](#comparison-attributes)

[8.15.3 Behavior of the Generated Object.Equals Implementation [172](#behavior-of-the-generated-object.equals-implementation)](#behavior-of-the-generated-object.equals-implementation)

[8.15.4 Behavior of the Generated CompareTo Implementations [172](#behavior-of-the-generated-compareto-implementations)](#behavior-of-the-generated-compareto-implementations)

[8.15.5 Behavior of the Generated GetHashCode Implementations [173](#behavior-of-the-generated-gethashcode-implementations)](#behavior-of-the-generated-gethashcode-implementations)

[8.15.6 Behavior of Hash, =, and Compare [173](#behavior-of-hash-and-compare)](#behavior-of-hash-and-compare)

[9. Units Of Measure [175](#units-of-measure)](#units-of-measure)

[9.1 Measures [176](#measures)](#measures)

[9.2 Constants Annotated by Measures [177](#constants-annotated-by-measures)](#constants-annotated-by-measures)

[9.3 Relations on Measures [177](#relations-on-measures)](#relations-on-measures)

[9.3.1 Constraint Solving [178](#constraint-solving)](#constraint-solving)

[9.3.2 Generalization of Measure Variables [179](#generalization-of-measure-variables)](#generalization-of-measure-variables)

[9.4 Measure Definitions [179](#measure-definitions)](#measure-definitions)

[9.5 Measure Parameter Definitions [179](#measure-parameter-definitions)](#measure-parameter-definitions)

[9.6 Measure Parameter Erasure [180](#measure-parameter-erasure)](#measure-parameter-erasure)

[9.7 Type Definitions with Measures in the F# Core Library [180](#type-definitions-with-measures-in-the-f-core-library)](#type-definitions-with-measures-in-the-f-core-library)

[9.8 Restrictions [181](#_Toc439782455)](#_Toc439782455)

[10. Namespaces and Modules [183](#namespaces-and-modules)](#namespaces-and-modules)

[10.1 Namespace Declaration Groups [183](#namespace-declaration-groups)](#namespace-declaration-groups)

[10.2 Module Definitions [185](#module-definitions)](#module-definitions)

[10.2.1 Function and Value Definitions in Modules [186](#function-and-value-definitions-in-modules)](#function-and-value-definitions-in-modules)

[10.2.2 Literal Definitions in Modules [187](#literal-definitions-in-modules)](#literal-definitions-in-modules)

[10.2.3 Type Function Definitions in Modules [188](#type-function-definitions-in-modules)](#type-function-definitions-in-modules)

[10.2.4 Active Pattern Definitions in Modules [189](#active-pattern-definitions-in-modules)](#active-pattern-definitions-in-modules)

[10.2.5 “do” statements in Modules [189](#do-statements-in-modules)](#do-statements-in-modules)

[10.3 Import Declarations [190](#import-declarations)](#import-declarations)

[10.4 Module Abbreviations [190](#module-abbreviations)](#module-abbreviations)

[10.5 Accessibility Annotations [191](#accessibility-annotations)](#accessibility-annotations)

[11. Namespace and Module Signatures [193](#_Toc439782467)](#_Toc439782467)

[11.1 Signature Elements [194](#signature-elements)](#signature-elements)

[11.1.1 Value Signatures [194](#value-signatures)](#value-signatures)

[11.1.2 Type Definition and Member Signatures [195](#type-definition-and-member-signatures)](#type-definition-and-member-signatures)

[11.2 Signature Conformance [195](#signature-conformance)](#signature-conformance)

[11.2.1 Signature Conformance for Functions and Values [196](#signature-conformance-for-functions-and-values)](#signature-conformance-for-functions-and-values)

[11.2.2 Signature Conformance for Members [197](#signature-conformance-for-members)](#signature-conformance-for-members)

[12. Program Structure and Execution [199](#program-structure-and-execution)](#program-structure-and-execution)

[12.1 Implementation Files [200](#implementation-files)](#implementation-files)

[12.2 Signature Files [201](#signature-files)](#signature-files)

[12.3 Script Files [202](#script-files)](#script-files)

[12.4 Compiler Directives [202](#compiler-directives)](#compiler-directives)

[12.5 Program Execution [204](#program-execution)](#program-execution)

[12.5.1 Execution of Static Initializers [204](#execution-of-static-initializers)](#execution-of-static-initializers)

[12.5.2 Explicit Entry Point [207](#explicit-entry-point)](#explicit-entry-point)

[13. Custom Attributes and Reflection [209](#custom-attributes-and-reflection)](#custom-attributes-and-reflection)

[13.1 Custom Attributes [209](#custom-attributes)](#custom-attributes)

[13.1.1 Custom Attributes and Signatures [211](#custom-attributes-and-signatures)](#custom-attributes-and-signatures)

[13.2 Reflected Forms of Declaration Elements [211](#reflected-forms-of-declaration-elements)](#reflected-forms-of-declaration-elements)

[14. Inference Procedures [213](#inference-procedures)](#inference-procedures)

[14.1 Name Resolution [213](#name-resolution)](#name-resolution)

[14.1.1 Name Environments [213](#name-environments)](#name-environments)

[14.1.2 Name Resolution in Module and Namespace Paths [214](#name-resolution-in-module-and-namespace-paths)](#name-resolution-in-module-and-namespace-paths)

[14.1.3 Opening Modules and Namespace Declaration Groups [214](#opening-modules-and-namespace-declaration-groups)](#opening-modules-and-namespace-declaration-groups)

[14.1.4 Name Resolution in Expressions [215](#name-resolution-in-expressions)](#name-resolution-in-expressions)

[14.1.5 Name Resolution for Members [218](#_Toc439782492)](#_Toc439782492)

[14.1.6 Name Resolution in Patterns [219](#name-resolution-in-patterns)](#name-resolution-in-patterns)

[14.1.7 Name Resolution for Types [220](#name-resolution-for-types)](#name-resolution-for-types)

[14.1.8 Name Resolution for Type Variables [221](#name-resolution-for-type-variables)](#name-resolution-for-type-variables)

[14.1.9 Field Label Resolution [221](#field-label-resolution)](#field-label-resolution)

[14.2 Resolving Application Expressions [221](#resolving-application-expressions)](#resolving-application-expressions)

[14.2.1 Unqualified Lookup [222](#unqualified-lookup)](#unqualified-lookup)

[14.2.2 Item-Qualified Lookup [223](#item-qualified-lookup)](#item-qualified-lookup)

[14.2.3 Expression-Qualified Lookup [224](#expression-qualified-lookup)](#expression-qualified-lookup)

[14.3 Function Application Resolution [226](#function-application-resolution)](#function-application-resolution)

[14.4 Method Application Resolution [226](#method-application-resolution)](#method-application-resolution)

[14.4.1 Additional Propagation of Known Type Information in F# 3.1 [232](#additional-propagation-of-known-type-information-in-f-3.1)](#additional-propagation-of-known-type-information-in-f-3.1)

[14.4.2 Conditional Compilation of Member Calls [232](#conditional-compilation-of-member-calls)](#conditional-compilation-of-member-calls)

[14.4.3 Implicit Insertion of Flexibility for Uses of Functions and Members [233](#implicit-insertion-of-flexibility-for-uses-of-functions-and-members)](#implicit-insertion-of-flexibility-for-uses-of-functions-and-members)

[14.5 Constraint Solving [234](#constraint-solving-1)](#constraint-solving-1)

[14.5.1 Solving Equational Constraints [235](#solving-equational-constraints)](#solving-equational-constraints)

[14.5.2 Solving Subtype Constraints [235](#solving-subtype-constraints)](#solving-subtype-constraints)

[14.5.3 Solving Nullness, Struct, and Other Simple Constraints [236](#solving-nullness-struct-and-other-simple-constraints)](#solving-nullness-struct-and-other-simple-constraints)

[14.5.4 Solving Member Constraints [236](#solving-member-constraints)](#solving-member-constraints)

[14.5.5 Over-constrained User Type Annotations [237](#over-constrained-user-type-annotations)](#over-constrained-user-type-annotations)

[14.6 Checking and Elaborating Function, Value, and Member Definitions [238](#checking-and-elaborating-function-value-and-member-definitions)](#checking-and-elaborating-function-value-and-member-definitions)

[14.6.1 Ambiguities in Function and Value Definitions [238](#ambiguities-in-function-and-value-definitions)](#ambiguities-in-function-and-value-definitions)

[14.6.2 Mutable Value Definitions [239](#mutable-value-definitions)](#mutable-value-definitions)

[14.6.3 Processing Value Definitions [239](#processing-value-definitions)](#processing-value-definitions)

[14.6.4 Processing Function Definitions [239](#processing-function-definitions)](#processing-function-definitions)

[14.6.5 Processing Recursive Groups of Definitions [240](#processing-recursive-groups-of-definitions)](#processing-recursive-groups-of-definitions)

[14.6.6 Recursive Safety Analysis [241](#recursive-safety-analysis)](#recursive-safety-analysis)

[14.6.7 Generalization [243](#generalization)](#generalization)

[14.6.8 Condensation of Generalized Types [245](#condensation-of-generalized-types)](#condensation-of-generalized-types)

[14.7 Dispatch Slot Inference [247](#dispatch-slot-inference)](#dispatch-slot-inference)

[14.8 Dispatch Slot Checking [248](#dispatch-slot-checking)](#dispatch-slot-checking)

[14.9 Byref Safety Analysis [249](#byref-safety-analysis)](#byref-safety-analysis)

[14.10 Arity Inference [250](#promotion-of-escaping-mutable-locals-to-objects)](#promotion-of-escaping-mutable-locals-to-objects)

[14.11 Additional Constraints on CLI Methods [252](#additional-constraints-on-cli-methods)](#additional-constraints-on-cli-methods)

[15. Lexical Filtering [253](#lexical-filtering)](#lexical-filtering)

[15.1 Lightweight Syntax [253](#lightweight-syntax-1)](#lightweight-syntax-1)

[15.1.1 Basic Lightweight Syntax Rules by Example [253](#basic-lightweight-syntax-rules-by-example)](#basic-lightweight-syntax-rules-by-example)

[15.1.2 Inserted Tokens [254](#inserted-tokens)](#inserted-tokens)

[15.1.3 Grammar Rules Including Inserted Tokens [254](#grammar-rules-including-inserted-tokens)](#grammar-rules-including-inserted-tokens)

[15.1.4 Offside Lines [255](#offside-lines)](#offside-lines)

[15.1.5 The Pre-Parse Stack [256](#the-pre-parse-stack)](#the-pre-parse-stack)

[15.1.6 Full List of Offside Contexts [256](#full-list-of-offside-contexts)](#full-list-of-offside-contexts)

[15.1.7 Balancing Rules [257](#balancing-rules)](#balancing-rules)

[15.1.8 Offside Tokens, Token Insertions, and Closing Contexts [258](#offside-tokens-token-insertions-and-closing-contexts)](#offside-tokens-token-insertions-and-closing-contexts)

[15.1.9 Exceptions to the Offside Rules [259](#exceptions-to-the-offside-rules)](#exceptions-to-the-offside-rules)

[15.1.10 Permitted Undentations [261](#permitted-undentations)](#permitted-undentations)

[15.2 High Precedence Application [262](#undentation-of-record-and-sequence-expressions-expressions)](#undentation-of-record-and-sequence-expressions-expressions)

[15.3 Lexical Analysis of Type Applications [263](#lexical-analysis-of-type-applications)](#lexical-analysis-of-type-applications)

[16. Provided Types [265](#provided-types)](#provided-types)

[16.1 Static Parameters [266](#static-parameters)](#static-parameters)

[16.1.1 Mangling of Static Parameter Values [266](#_Toc439782542)](#_Toc439782542)

[16.2 Provided Namespace [267](#provided-namespace)](#provided-namespace)

[16.3 Provided Type Definitions [267](#provided-type-definitions)](#provided-type-definitions)

[16.3.1 Generated v. Erased Types [267](#generated-v.-erased-types)](#generated-v.-erased-types)

[16.3.2 Type References [268](#type-references)](#type-references)

[16.3.3 Static Parameters [268](#static-parameters-1)](#static-parameters-1)

[16.3.4 Kind [268](#kind)](#kind)

[16.3.5 Inheritance [269](#inheritance)](#inheritance)

[16.3.6 Members [269](#members-1)](#members-1)

[16.3.7 Attributes [270](#attributes)](#attributes)

[16.3.8 Accessibility [270](#accessibility)](#accessibility)

[16.3.9 Elaborated Code [270](#elaborated-code)](#elaborated-code)

[16.3.10 Further Restrictions [271](#further-restrictions)](#further-restrictions)

[17. Special Attributes and Types [272](#special-attributes-and-types)](#special-attributes-and-types)

[17.1 Custom Attributes Recognized by F# [272](#custom-attributes-recognized-by-f)](#custom-attributes-recognized-by-f)

[17.2 Custom Attributes Emitted by F# [277](#custom-attributes-emitted-by-f)](#custom-attributes-emitted-by-f)

[17.3 Custom Attributes Not Recognized by F# [278](#custom-attributes-not-recognized-by-f)](#custom-attributes-not-recognized-by-f)

[17.4 Exceptions Thrown by F# Language Primitives [278](#exceptions-thrown-by-f-language-primitives)](#exceptions-thrown-by-f-language-primitives)

[18. The F# Library FSharp.Core.dll [281](#_Toc439782560)](#_Toc439782560)

[18.1 Basic Types (FSharp.Core) [281](#basic-types-fsharp.core)](#basic-types-fsharp.core)

[18.1.1 Basic Type Abbreviations [281](#basic-type-abbreviations)](#basic-type-abbreviations)

[18.1.2 Basic Types that Accept Unit of Measure Annotations [281](#basic-types-that-accept-unit-of-measure-annotations)](#basic-types-that-accept-unit-of-measure-annotations)

[18.1.3 The nativeptr<_> Type [282](#the-nativeptr_-type)](#the-nativeptr_-type)

[18.2 Basic Operators and Functions (FSharp.Core.Operators) [282](#basic-operators-and-functions-fsharp.core.operators)](#basic-operators-and-functions-fsharp.core.operators)

[18.2.1 Basic Arithmetic Operators [282](#basic-arithmetic-operators)](#basic-arithmetic-operators)

[18.2.2 Generic Equality and Comparison Operators [283](#generic-equality-and-comparison-operators)](#generic-equality-and-comparison-operators)

[18.2.3 Bitwise Operators [283](#bitwise-operators)](#bitwise-operators)

[18.2.4 Math Operators [283](#math-operators)](#math-operators)

[18.2.5 Function Pipelining and Composition Operators [284](#function-pipelining-and-composition-operators)](#function-pipelining-and-composition-operators)

[18.2.6 Object Transformation Operators [284](#object-transformation-operators)](#object-transformation-operators)

[18.2.7 Pair Operators [284](#pair-operators)](#pair-operators)

[18.2.8 Exception Operators [284](#exception-operators)](#exception-operators)

[18.2.9 Input/Output Handles [284](#inputoutput-handles)](#inputoutput-handles)

[18.2.10 Overloaded Conversion Functions [285](#overloaded-conversion-functions)](#overloaded-conversion-functions)

[18.3 Checked Arithmetic Operators [285](#checked-arithmetic-operators)](#checked-arithmetic-operators)

[18.4 List and Option Types [286](#list-and-option-types)](#list-and-option-types)

[18.4.1 The List Type [286](#the-list-type)](#the-list-type)

[18.4.2 The Option Type [286](#the-option-type)](#the-option-type)

[18.5 Lazy Computations (Lazy) [286](#lazy-computations-lazy)](#lazy-computations-lazy)

[18.6 Asynchronous Computations (Async) [286](#asynchronous-computations-async)](#asynchronous-computations-async)

[18.7 Query Expressions [287](#query-expressions)](#query-expressions)

[18.8 Agents (MailboxProcessor) [287](#agents-mailboxprocessor)](#agents-mailboxprocessor)

[18.9 Event Types [287](#event-types)](#event-types)

[18.10 Immutable Collection Types (Map, Set) [287](#immutable-collection-types-map-set)](#immutable-collection-types-map-set)

[18.11 Text Formatting (Printf) [287](#text-formatting-printf)](#text-formatting-printf)

[18.12 Reflection [287](#reflection)](#reflection)

[18.13 Quotations [287](#quotations)](#quotations)

[18.14 Native Pointer Operations [287](#native-pointer-operations)](#native-pointer-operations)

[18.14.1 Stack Allocation [288](#stack-allocation)](#stack-allocation)

[19. Features for ML Compatibility [289](#features-for-ml-compatibility)](#features-for-ml-compatibility)

[19.1 Conditional Compilation for ML Compatibility [289](#conditional-compilation-for-ml-compatibility)](#conditional-compilation-for-ml-compatibility)

[19.2 Extra Syntactic Forms for ML Compatibility [289](#extra-syntactic-forms-for-ml-compatibility)](#extra-syntactic-forms-for-ml-compatibility)

[19.3 Extra Operators [290](#extra-operators)](#extra-operators)

[19.4 File Extensions and Lexical Matters [291](#file-extensions-and-lexical-matters)](#file-extensions-and-lexical-matters)

[Appendix A: F# Grammar Summary [292](#_Toc439782596)](#_Toc439782596)

[References [313](#references)](#references)

[Glossary [314](#glossary)](#glossary)

[Index [326](#index)](#index)
...
if *expr* then *expr* *elif-branches_(opt)* *else-branch*_(opt) -- conditional expression
...
inline*_(opt)* *access_(opt)* *ident-or-op typar-defns_(opt)* *argument-pats* *return-type_(opt)* = *expr*

*value-defn* :=

mutable*_(opt)* *access_(opt)* *pat* *typar-defns_(opt)* *return-type_(opt)* = *expr*
...
interface *type* *object-members_(opt)* -- interface implementation
...
Each *field-initializer_(i)* has the form *field-label_(i)* = *expr_(i)*. Each *field-label_(i)* is a *long-ident*, which must resolve to a field *F*_(i) in a unique record type *R* as follows:

- If *field-label*_(i) is a single identifier *fld* and the initial type is known to be a record type *R*<_,...,_> that has field F_(i) with name *fld*, then the field label resolves to F_(i).

- If *field-label*_(i) is not a single identifier or if the initial type is a variable type, then the field label is resolved by performing *Field Label Resolution* (see §14.1) on *field-label*_(i). This procedure results in a set of fields *FSet*_(i). Each element of this set has a corresponding record type, thus resulting in a set of record types *RSet*_(i). The intersection of all *RSet*_(i) must yield a single record type *R*, and each field then resolves to the corresponding field in *R*.
...
1. Assume the type of the corresponding field F_(i) in *R*<*ty₁*,...,*ty_(N)*> is fty_(i)

2. If the type of F_(i) prior to taking into account the instantiation <*ty₁*,...,*ty_(N)*> is a named type, then the initial type is a fresh type inference variable *fty'*_(i) with a constraint *fty'*_(i) :> *fty*_(i).
...
The expression *expr* is first checked with the same initial type as the overall expression. Next, the field definitions are resolved by using the same technique as for record expressions. Each field label must resolve to a field *F*_(i) in a single record type *R*, all of whose fields are accessible. After all field labels are resolved, the overall record expression is asserted to be of type *R*<*ty₁*,...,*ty_(N)*> for fresh types *ty₁*,...,*ty_(N)*. Each expr_(i) is then checked in turn with initial type that results from the following procedure:

1. Assume the type of the corresponding field F_(i) in *R*<*ty₁*,...,*ty_(N)*> is fty_(i).

2. If the type of F_(i) before considering the instantiation <*ty₁*,...,*ty_(N)*> is a named type, then the initial type is a fresh type inference variable *fty'*_(i) with a constraint *fty'*_(i) :> *fty*_(i).
...
{ new *ty₀* *args-expr*_(opt) *object-members*
...
**T**(use! p = e in ce, **V**, **C**, q) = **C**(b.Bind(*src*(e), fun p -> b.Using(p, fun p -> {| *ce* |}₀))

**T**(match e with p_(i) -> ce_(i), **V**, **C**, q) = **C**(match e with p_(i) -> {| *ce*_(i) |}₀)

**T**(while e do ce, **V**, **C**, q) = **T**(ce, **V**, λv.**C**(b.While(fun () -> e, b.Delay(fun () -> v))), q)

**T**(try ce with p_(i) -> ce_(i), **V**, **C**, q) =  
Assert(not q); **C**(b.TryWith(b.Delay(fun () -> {| *ce* |}₀), fun p_(i) -> {| *ce*_(i) |}₀))

**T**(try ce finally e, **V**, **C**, q) =  
Assert(not q); **C**(b.TryFinally(b.Delay(fun () -> {| *ce* |}₀), fun () -> e))

**T**(if e then ce, **V**, **C**, q) = **T**(ce, **V**, λv.**C**(if e then v else b.Zero()), q)

**T**(if e then ce₁ else ce₂, **V**, **C**, q) = Assert(not q); **C**(if e then {| *ce*₁ |}₀) else {| *ce*₂ |}₀)

**T**(for x = e₁ to e₂ do ce, **V**, **C**, q) = **T**(for x in e₁ .. e₂ do ce, **V**, **C**, q)

**T**(for p₁ in e₁ do joinOp p₂ in e₂ onWord (e₃ *eop* e₄) ce, **V**, **C**, q) =  
Assert(q); **T**(for *pat*(**V**) in b.Join(*src*(e₁), *src*(e₂), λp₁.e₃, λp₂.e₄,  
λp₁. λp₂.(p₁,p₂)) do ce, **V** , **C**, q)

**T**(for p₁ in e₁ do groupJoinOp p₂ in e₂ onWord (e₃ *eop* e₄₎ into p₃ ce, **V**, **C**, q) =  
Assert(q); **T**(for *pat*(**V**) in b.GroupJoin(*src*(e₁₎,  
*src*(e₂₎, λp_(1.)e_(3,) λp_(2.)e_(4,) λp_(1.) λp_(3.)(p_(1,)p₃₎) do ce, **V** , **C**, q)
...
**T**(joinOp p₂ in e₂ on (e₃ *eop* e₄₎ ce, **V**, **C**, q) = **  
T**(for *pat*(**V**) in **C**({| yield *exp*(**V**) |}₀₎ do join p₂ in e₂ onWord (e₃ *eop* e₄₎ ce, **V**, λv.v, q)

**T**(groupJoinOp p₂ in e₂ onWord (e₃ eop e₄₎ into p₃ ce, **V**, **C**, q) = **  
T**(for *pat*(**V**) in **C**({| yield *exp*(**V**) |}₀₎ do groupJoin p₂ in e₂ on (e₃ *eop* e₄₎ into p₃ ce,  
**V**, λv.v, q)

**T**([<CustomOperator("Cop")>]cop arg, **V**, **C**, q) = Assert (q); [| cop arg, **C**(b.Yield *exp*(**V**)) |]**_(V)**
...
**T**(ce_(1;) ce_(2,) **V**, **C**, q) = **C**(b.Combine({| ce₁ |}_(0,) b.Delay(fun () -> {| ce₂ |}₀₎))
...
**CL** (e_(1,) **V,** e2, bind) where e_(1:) the computation expression being translated

**V**: a set of scoped variables

e₂: the expression that will be translated after e₁ is done
...
> **CL** (cop arg, **V**, e’, bind) = [| cop arg, e’ |]**_(V)**
>
...
> CL** (e, **V**, [| cop arg, e’ |]_(**V**,) true)
>
> **CL** ([<MaintainsVariableSpaceUsingBind=true>]cop arg; e, **V**, e’, bind) = **  
> CL** (e, **V**, [| cop arg, e’ |]**_(V)**, true)
>
> **CL** (cop arg; e, **V**, e’, bind) = **CL** (e, [], [| cop arg, e’ |]_(**V**,) false)
>
> **CL** (e, **V**, e’, true) = **T**(let! *pat*(**V**) = e’ in e, **V**, λv.v, true)
>
> **CL** (e, **V**, e’, false) = **T**(for *pat*(**V**) in e’ do e, **V**, λv.v, true)

- The auxiliary translation [| e1, e2 |]_(V) is defined as follows:

[|[ e1, e2 |]**_(V)** where e_(1:) the custom operator available in a build

e₂: the context argument that will be passed to a custom operator

**V**: a list of bound variables

[|[<CustomOperator(" Cop")>] cop [<ProjectionParameter>] arg, e |]**_(V)** =

> b.Cop (e, fun *pat*(**V)** -> arg)

[|[<CustomOperator("Cop")>] cop arg, e |]**_(V)** = b.Cop (e, arg)
...
{| *expr₁* ; *expr₂ *|} Seq.append {| *expr₁* |} {| *expr₂ *|}

{| for *pat* in *expr₁* -> *expr₂ *|} Seq.map (fun *pat* -> {| *expr₂* |}) *expr₁*

{| for *pat* in *expr₁* do *expr₂ *|} Seq.collect (fun *pat* -> {| *expr₂* |}) *expr₁*

{| while *expr₁* do *expr₂ *|} RuntimeHelpers.EnumerateWhile

(fun () -> *expr₁*)

{| *expr₂* |})

{| try *expr₁* finally *expr₂ *|} RuntimeHelpers.EnumerateThenFinally

(| *expr₁* |})

(fun () -> *expr₂*)

{| use *v* = *expr₁* in *expr₂ *|} let *v* = *expr₁* in

RuntimeHelpers.EnumerateUsing v {| *expr₂* |}

{| let *v* = *expr₁* in *expr₂ *|} let *v* = *expr₁* in {| *expr₂* |}

{| match *expr* with *pat_(i)* -> *expr_(i)* |} .match *expr* with *pat_(i)* -> {| *cexpr_(i)* |}

{| *expr₁* |} *expr₁* ; Seq.empty

{| if *expr* then *expr₀* |}_(C) if *expr* then {| *expr₀* |}_(C) else Seq.empty

{| if *expr* then *expr₀* else *expr₁ *|} if *expr* then {| *expr₀* |}_(C) else {| *expr₁* |}_(C)
...
Range expressions involving *expr₁* .. *expr₂ *are translated to uses of the (..) operator, and those involving *expr₁* .. *expr₁* .. *expr₃ *are translated to uses of the (.. ..) operator:

seq { *e1* .. *e2* } → (*..*) *e₁* *e₂*

seq { *e1* .. *e2 .. e3* } → (*.. ..*) *e₁* *e₂* *e₃*

The default definition of these operators is in FSharp.Core.Operators. The (*..*) operator generates an IEnumerable<_> for the range of values between the start (*expr₁*) and finish (*expr₂*) values, using an increment of 1 (as defined by FSharp.Core.LanguagePrimitives.GenericOne). The (*.. ..*) operator generates an IEnumerable<_> for the range of values between the start (*expr₁*) and finish (*expr₃*) values, using an increment of *expr₂*.
...
- for *var* in *expr*₁ .. *expr*₂ do *expr*₃

A sequence iteration expression of the form for *var* in *expr*₁ .. *expr*₂ do *expr*₃ done is sometimes elaborated as a simple for loop-expression (§6.5.7).
...
- The use of optional arguments results in the insertion of Some(_) and None data constructions in the elaborated expression.
  ...
  For uses of active pattern results (see §10.2.4), for result *i* in an active pattern that has *N* possible results of types *types*, the elaborated expression form is a union case Choice*N*Of*i* of type FSharp.Core.Choice<*types*>.
...
*e₁*.[*e_(args)*] → *e₁*.get_Item(*e_(args)*)

*e₁*.[*e_(args)*] <- e₃ → *e₁*.set_Item(*e_(args)*, *e₃*)
...
- A mutable value *path* of type *ty*.
  ...
  Type checking of *expr₂* uses the expected result type *ty* and generates an elaborated expression *expr₂*. The overall elaborated expression is an assignment to a value reference *&path <-*_(stobj) *expr*₂.

- A reference to a value *path* of type byref<*ty*>.

  Type checking of *expr₂* uses the expected result type *ty* and generates an elaborated expression *expr₂*. The overall elaborated expression is an assignment to a value reference *path <-*_(stobj) *expr*₂.

- A reference to a mutable field *expr*_(1a).*field* with the actual result type *ty*.

  Type checking of *expr₂* uses the expected result type *ty* and generatesan elaborated expression *expr₂*. The overall elaborated expression is an assignment to a field (see §6.9.4):

*AddressOf*(*expr*_(1a).*field*, DefinitelyMutates) *<-*_(stobj) *expr*₂

- A array lookup *expr*_(1a).[*expr*_(1b)] where *expr*_(1a) has type *ty*[].

  Type checking of *expr₂* uses the expected result type *ty* and generates thean elaborated expression *expr₂*. The overall elaborated expression is an assignment to a field (see §6.9.4):

*AddressOf*(*expr*_(1a).[*expr*_(1b)] , DefinitelyMutates) *<-*_(stobj) *expr*₂
...
if *expr*_(1a) then *expr*_(1b)

elif *expr*_(3a) then *expr*_(2b)

…

elif *expr*_(na) then *expr*_(nb)
...
*expr₁* && *expr₂* → if *expr₁* then *expr₂ *else false

*expr₁* || *expr₂* → if *expr₁* then true else *expr₂ *
...
The done token is optional if *expr*₂ appears on a later line and is indented from the column position of the for token. In this case, parsing inserts a $done token automatically and applies an additional syntax rule for lightweight syntax (§15.1.1).
...
The expression *expr*₁ is checked with a fresh initial type *ty*_(expr,) which is then asserted to be a subtype of type IEnumerable<*ty*>, for a fresh type *ty*. If the assertion succeeds, the expression elaborates to the following, where *v* is of type IEnumerator<*ty*> and *pat* is a pattern of type *ty*:
...
If the assertion fails, the type *ty*_(expr) may also be of any static type that satisfies the “collection pattern” of CLI libraries. If so, the *enumerable extraction* process is used to enumerate the type. In particular, *ty*_(expr) may be any type that has an accessible GetEnumerator method that accepts zero arguments and returns a value that has accessible MoveNext and Current properties. The type of *pat* is the same as the return type of the Current property on the enumerator value. However, if the Current property has return type obj and the collection type *ty* has an Item property with a more specific (non-object) return type *ty₂*, type *ty₂* is used instead, and a dynamic cast is inserted to convert v.Current to *ty₂*.

A sequence iteration of the form

for *var* in *expr*₁ .. *expr*₂ do *expr*₃ done

where the type of *expr*₁ or *expr*₂ is equivalent to int, is elaborated as a simple for-loop expression (§6.5.7)
...
The bounds *expr*₁ and *expr*₂ are checked with initial type int. The overall type of the expression is unit. A warning is reported if the body *expr*₃ of the for loop does not have static type unit.
...
is always elaborated as a simple for-loop expression whenever the type of *expr*₁ or *expr*₂ is equivalent to int.
...
The done token is optional when *expr*₂ appears on a subsequent line and is indented from the column position of the while. In this case, a $done token is automatically inserted, and an additional syntax rule for lightweight syntax applies (§15.1.1).
...
The overall type of the expression is unit. The expression *expr*₁ is checked with initial type bool. A warning is reported if the body *expr*₂ of the while loop cannot be asserted to have type unit.
...
mutable_(opt) *access_(opt)* *pat* *typar-defns_(opt)* *return-type_(opt)* = *rhs-expr*

Checking proceeds as follows:

1. Check the *value-defn* (§14.6), which defines a group of identifiers *ident_(j)* with inferred types *ty_(j)*

2. Add the identifiers *ident_(j)* to the name resolution environment, each with corresponding type *ty_(j)*.
...
where *tmp* is a fresh identifier and *ident_(i)*, *typars_(i)*, and *expr_(i)* all result from the compilation of the pattern *pat* (§7) against the input *tmp*.
...
The expression is first checked as an expression of form let *ident* = *expr₁* in *expr₂* (§**Error! Reference source not found.**), which results in an elaborated expression of the following form:
...
The initial type of the overall expression is *ty*. Expression *expr* is checked using a fresh initial type *ty_(e)*, with constraint *ty_(e)* :> *ty*. Static coercions are a primitive elaborated form.
...
The initial type of the overall expression is *bool*. Expression *expr* is checked using a fresh initial type *ty_(e)*. After checking:

- The type *ty_(e)* must not be a variable type.

- A warning is given if the type test will always be true and therefore is unnecessary.

- The type *ty_(e)* must not be sealed.

- If type *ty* is sealed, or if *ty* is a variable type, or if type *ty_(e)* is not an interface type, then *ty :> ty_(e)* is asserted.
...
The initial type of the overall expression is *ty*. Expression *expr* is checked using a fresh initial type *ty_(e)*. After these checks:
...
- If *expr* has form *expr_(a).field* where *field* is a mutable, non-readonly CLI field, the elaborated form is &(*AddressOf*(*expr_(a)*)*.field*).

- If *expr* has form *expr_(a).*[*expr_(b)*] where the operation is an array lookup, the elaborated form is &(*AddressOf*(*expr_(a)*)*.*[*expr_(b)*]).
...
- If *f* evaluates to a function value with more than *n* arguments, then a new function value is returned with an extended closure mapping *n* additional formal argument names to the argument values for *e₁* ... *e_(m)*.
...
- If the method is declared abstract—that is, if it is a virtual dispatch slot—then the body of the member is chosen according to the dispatch maps of the value of *e₀* (§14.8).
...
{ new ty₀ args-expr_(opt) object-members
...
- The expression evaluates to an object whose runtime type is compatible with all of the *ty_(i)* and which has the corresponding dispatch map (§14.8). If present, the base construction expression *ty*₀ (*args-expr*) is executed as the first step in the construction of the object.
...
As runtime, while-loops while *expr₁* do *expr₂* done are evaluated as follows:
...
- If *ty_(e)*uses null as a representation (§5.4.8), the result is true.
...
- If *ty_(e)*uses null as a representation (§5.4.8), the result is the null value.
...
At runtime, elaborated sequential expressions *expr₁*; *expr₂* are evaluated as follows:

- The expression *expr₁* is evaluated for its side effects and the result is discarded.

- The expression *expr₂* is evaluated to a value *v₂* and the result of the overall expression is *v₂*.

### Evaluating Try-with Expressions

At runtime, elaborated try-with expressions try *expr₁* with *rules* are evaluated as follows:

- The expression *expr₁* is evaluated to a value *v₁*.
...
- If a rule *pat -> expr₂* matches, the mapping *pat = v₁* is added to the local environment, and *expr₂* is evaluated.

### Evaluating Try-finally Expressions

At runtime, elaborated try-finally expressions try *expr₁* finally *expr₂* are evaluated as follows:

- The expression *expr₁* is evaluated.

- If the result of this evaluation is a value *v* , then *expr₂* is evaluated.
...
- If the result of this evaluation is an exception, then *expr₂* is evaluated.
...
*long-ident* *pat-param_(opt)* *pat_(opt)* -- named pattern
...
If *long-ident* from §7.2 resolves to an *active pattern case name* *CaseName_(i)* then the pattern is an active pattern. The rules for name resolution in patterns (§14.1.6) ensure that *CaseName_(i)* is associated with an *active pattern function* *f* in one of the following forms:
...
At runtime, the function *f* is applied to the pattern input, along with any parameters. The pattern matches if the active pattern function returns *v*, Choice*k*Of*N v*, or Some *v*, respectively, when applied to the pattern input. If the pattern argument *pat* is present, it is then matched against *v*.
...
If the pattern input has type *ty_(in)*, pattern checking uses the same conditions as both a dynamic type-test expression *e* :? *type* and a dynamic coercion expression *e* :?> *type* where *e* has type *ty_(in)*. An error occurs if *type* cannot be statically determined to be a subtype of the type of the pattern input*.* A warning occurs if the type test will always succeed based on *type* and the static type of the pattern input.
...
The *long-ident_(i)* are resolved in the same way as field labels for record expressions and must together identify a single, unique F# record type. Not all record fields for the type need to be specified in the pattern.
...
*attributes_(opt) access_(opt) ident* *typar-defns*_(opt)
...
*type-name* '=' *union-type-cases type-extension-elements_(opt)*

*union-type-cases* :=

'|'*_(opt)* *union-type-case* '|' ... '|' *union-type-case*

*union-type-case* :=

*attributes_(opt) union-type-case-data*
...
*type-name* *=* '{' *record-fields* '}' *type-extension-elements_(opt)*

*record-fields* :=

*record-field* ; ... ; *record-field* ;*_(opt)*

*record-field* :=

*attributes_(opt)* mutable*_(opt)* *access_(opt)* *ident* : *type*

*anon-type-defn* :=

*type-name* *primary-constr-args_(opt)* *object-val_(opt)* '=' begin *class-type-body* end

*class-type-defn* :=

*type-name* *primary-constr-args_(opt)* *object-val_(opt)* '=' class *class-type-body* end

*as-defn* := as *ident*

*class-type-body* :=

*class-inherits-decl_(opt) class-function-or-value-defns_(opt) type-defn-elements_(opt)*

*class-inherits-decl* := inherit *type* *expr_(opt)*

*class-function-or-value-defn* :=

*attributes_(opt)* static*_(opt)* let rec*_(opt)* *function-or-value-defns*

*attributes_(opt)* static*_(opt)* do *expr*

*struct-type-defn* :=

*type-name primary-constr-args_(opt)* *as-defn_(opt)* '=' struct *struct-type-body* end
...
*attributes_(opt)* exception *union-type-case-data* -- exception definition

*attributes_(opt)* exception *ident* = *long-ident* -- exception abbreviation
...
'|'*_(opt)* *enum-type-case* '|' ... '|' *enum-type-case*
...
*attributes_(opt)* *access_(opt)* (*simple-pat, ... , simple-pat*)
...
*attributes_(opt)* *access_(opt)* new *pat* *as-defn* = *additional-constr-expr*
...
*attributes_(opt)* static*_(opt)* member *access_(opt)* *method-or-prop-defn* -- concrete member

*attributes_(opt)* abstract member*_(opt)* *access_(opt)* *member-sig* -- abstract member

*attributes_(opt)* override *access_(opt)* *method-or-prop-defn* -- override member

*attributes_(opt)* default *access_(opt)* *method-or-prop-defn* -- override member

*attributes_(opt)* static*_(opt)* val mutable*_(opt)* *access_(opt)* *ident* *: type* -- value member

*additional-constr-defn* -- additional constructor

*method-or-prop-defn* :=

*ident._(opt) function-defn* -- method definition

*ident._(opt) value-defn* -- property definition

*ident._(opt) ident* with *function-or-value-defns* -- property definition via get/set methods
...
*ident typar-defns_(opt)* : *curried-sig --* method or property signature

*ident typar-defns_(opt)* : *curried-sig* with get -- property signature

*ident typar-defns_(opt)* : *curried-sig* with set -- property signature

*ident typar-defns_(opt)* : *curried-sig* with get,set -- property signature

*ident typar-defns_(opt)* : *curried-sig* with set,get -- property signature
...
*attributes_(opt)* *arg-name-spec_(opt) type*
...
- For each type definition *T*, the subsequent steps use an environment *env_(T)* that is produced by adding the type definitions themselves and the generic arguments for *T* to *env*.
...
For a record type, the record field labels field*₁* ... field*_(N)* are added to the *FieldLabels* table of the current name resolution environmentunless the record type has the RequireQualifiedAccess attribute.
...
type *type-name* *pat_(opt)* *as-defn_(opt)* =

class

*class-inherits-decl_(opt)*

*class-function-or-value-defns_(opt)*
...
static*_(opt)* member *ident*.*_(opt)* *ident* = *expr*

static*_(opt)* member *ident*.*_(opt)* *ident* with get *pat* = *expr*

static*_(opt)* member *ident*.*_(opt)* *ident* with set *pat_(opt) pat*= *expr*

static*_(opt)* member *ident*.*_(opt)* *ident* with get *pat* = *expr* and set *pat_(opt) pat* = *expr*

static*_(opt)* member *ident*.*_(opt)* *ident* with set *pat_(opt) pat* = *expr* and get *pat* = *expr*

A property member in the form

static*_(opt)* member *ident*.*_(opt)* *ident* with get *pat₁* = *expr₁* and set *pat_(2a) pat_(2b)*_(opt) = *expr₂*

is equivalent to two property members of the form:

static*_(opt)* member *ident*.*_(opt)* *ident* with get *pat₁* = *expr₁*

static*_(opt)* member *ident*.*_(opt)* *ident* with set *pat_(2a) pat_(2b)* _(opt) = *expr₂*

Furthermore, the following two members are equivalent:

static*_(opt)* member *ident*.*_(opt)* *ident* = *expr*

static*_(opt)* member *ident*.*_(opt)* *ident* with get () = *expr*

These two are also equivalent:

static*_(opt)* member *ident*.*_(opt)* *ident* with set *pat* = *expr₂*

static*_(opt)* member *ident*.*_(opt)* *ident* with set () *pat* = *expr*

Thus, property members may be reduced to the following two forms:

static*_(opt)* member *ident*.*_(opt)* *ident* with get *pat_(idx)* = *expr*

static*_(opt)* member *ident*.*_(opt)* *ident* with set *pat_(idx) pat* = *expr*

The *ident*.*_(opt)* must be present if and only if the property member is an instance member. When evaluated, the identifier *ident* is bound to the “this” or “self” object parameter that is associated with the object within the expression *expr*.
...
static*_(opt)* member val *access_(opt)* *ident* *:* *ty_(opt)* = expr

static*_(opt)* member val *access_(opt)* *ident* *:* *ty_(opt)* = expr with get

static*_(opt)* member val *access_(opt)* *ident* *:* *ty_(opt)* = expr with set

static*_(opt)* member val *access_(opt)* *ident* *:* *ty_(opt)* = expr with get, set
...
Events from CLI languages are revealed as object properties of type FSharp.Control.IEvent<*ty*_(delegate), *ty*_(args)>. The F# compiler determines the type arguments, which are derived from the CLI delegate type that is associated with the event.

Event declarations are not built into the F# language, and event is not a keyword. However, property members that are marked with the CLIEvent attribute and whose type coerces to FSharp.Control.IDelegateEvent<*ty*_(delegate)> are compiled to include extra CLI metadata and methods that mark the property name as a CLI event. For example, in the following code, the ChannelChanged property is currently compiled as a CLI event:
...
abstract *access_(opt)* *member-sig*

where a member signature has one of the following forms

*ident typar-defns_(opt) : curried-sig*

*ident typar-defns_(opt) : curried-sig* with get

*ident typar-defns_(opt) : curried-sig* with set

*ident typar-defns_(opt) : curried-sig* with get, set
...
F# supports static checking of *units of measure*. Units of measure, or *measure*s for short, are like types in that they can appear as parameters to other types and values (as in float<kg>, vector<m/s>, add<m>), can contain variables (as in float<'U>), and are checked for consistency by the type-checker.
...
- *Commutativity*. *measure-int₁ measure-int₂* is equivalent to *measure-int₂ measure-int₁*.
...
This normalized form provides a convenient way to check the equality of measures: given two measure expressions *measure-int₁* and *measure-int₂*, reduce each to normalized form by using the rules of commutativity, associativity, identity, inverses and abbreviation, and then compare the syntax.
...
The mechanism described in §14.5 is extended to support equational constraints between measure expressions. Such expressions arise from equations between parameterized types—that is, when *type*<*tyarg₁₁*,..., *tyarg_(1n)*> = *type*<*tyarg₂₁*,..., *tyarg_(2n)*> is reduced to a series of constraints *tyarg_(1i)* = *tyarg_(2i)*. For the arguments that are measures, rather than types, the rules listed in §9.3 are applied to obtain primitive equations of the form 'U = *measure-int* where 'U is a measure variable and *measure-int* is a measure expression in internal form. The variable 'U is then replaced by *measure-int* wherever else it occurs. For example, the equation float<m^2/s^2> = float<'U^2> would be reduced to the constraint m^2/s^2 = 'U^2, which would be further reduced to the primitive equation 'U = m/s.
...
*attributes_(opt)* module *access_(opt)* *ident* = *module-defn-body*

*module-defn-body* :=

begin *module-elems_(opt)* end
...
*attributes_(opt)* let rec*_(opt)* *function-or-value-defns*
...
When a module definition *M* is checked in an environment *env₀*, the individual declarations are checked in order and an overall *module signature* *M_(sig)* is inferred for the module. An entry for *M* is then added to the *ModulesAndNamespaces* table to environment *env₀* to form the new environment used for checking subsequent modules.
...
val mutable*_(opt)* *curried-sig* -- value signature
...
*attributes_(opt)* access*_(opt)* new : *uncurried-sig* -- constructor signature

*attributes_(opt)* member access*_(opt)* *member-sig* *--* member signature

*attributes_(opt)* abstract access*_(opt)* *member-sig --* member signature

*attributes_(opt)* override *member-sig --* member signature

*attributes_(opt)* default *member-sig --* member signature

*attributes_(opt)* static member access*_(opt)* *member-sig* -- static member signature

interface *type* -- interface signature

*abbrev-type-signature* := *type-name* '=' *type*

*union-type-signature* := *type-name* '=' *union-type-cases type-extension-elements-signature_(opt)*

*record-type-signature* := *type-name* '=' '{' *record-fields* '}' *type-extension-elements-signature_(opt)*
...
1.  Check it against the current signature environment *sig-env_(i-1)*, which generates the signature *Sig_(file)* for the current file.

2.  Add *Sig_(file)* to *sig-env_(i-1)* to produce *sig-env*_(i) to make it available for use in later signature files.

    The processing of the signature file has no effect on the implementation environment, so *impl-env_(i)* is identical to *impl-env_(i-1)*.
...
1.  If a corresponding signature *Sig_(file)* exists, check *Impl_(file)* against *Sig_(file)* during this process (§11.2). Then add *Sig_(file)* to *impl-env_(i-1)* to produce *impl-env*_(i). This step makes the signature-constrained view of the implementation file available for use in later implementation files. The processing of the implementation file has no effect on the signature environment, so *sig-env_(i)* is identical to *sig-env_(i-1)*.

&nbsp;

3.  If the implementation file has no signature file, add *Impl_(file)* to both *sig-env_(i-1)* and *impl-env_(i-1)*, to produce *sig-env*_(i) and *impl-env*_(i). This makes the contents of the implementation available for use in both later signature and implementation files.
...
- Check the namespace declaration groups in the file against the existing environment *env_(i-1)* and incrementally add them to the environment (§10.1) to create a new environment *env_(i)*.
...
- Check each *namespace-decl-group-signature_(i)* in *env_(i-1)* and add the result to that environment to create a new environment *env_(i)*.
...
*attribute* := *attribute-target*:*_(opt)* *object-construction*
...
- By default, a custom attribute on a record field F for a type T is compiled to a custom attribute on the CLI property for the fieldthat is named F, unless the target of the attribute is field, in which case it becomes a custom attribute on the underlying backing field for the CLI property that is named \_F.
...
- *ModulesAndNamespaces*: a table that maps *long-ident*s to a list of signatures. Each signature is either a namespace declaration group signature or a module signature.
...
1.  If the type is a class or struct type (or an abbreviation of such a type), add the type name to the *ExprItems* table.

&nbsp;

1.  If the type definition is a record, add the record field labels to the *FieldLabels* table, unless the type has the RequireQualifiedAccess attribute.

2.  If the type is a union, add the union cases to the *ExprItems* and *PatItems* tables, unless the type has the RequireQualifiedAccess attribute.

3.  Add the type to the *TypeNames* table. If the type has a CLI-encoded generic name such as List`1, add an entry under both List and List`1.

3. Add each value in the original order of declaration in *F*, as follows:

1.  Add the value to the *ExprItems* table.

&nbsp;

4.  If any value is an active pattern, add the tags of that active pattern to the *PatItems* table according to the original order of declaration.

5.  If the value is a literal, add it to the *PatItems* table.

4. Add the member contents of each type extension in *F_(i)* to the *ExtensionsInScope* table according to the original order of declaration in *F_(i)*.

5. Add each sub-module or sub-namespace declaration group in *F_(i)* to the *ModulesAndNamespaces* table according to the original order of declaration in *F_(i)*.

6. Open any sub-modules that are marked with the FSharp.Core.AutoOpen attribute.

### Name Resolution in Expressions

Given an input *long-ident*, environment *env*, and an optional count *n* of the number of subsequent type arguments <*_,...,_*>, *Name Resolution in Expressions* computes a result that contains the interpretation of the *long-ident*<*_,...,_*> prefix as a value or other expression item, and a residue path *rest*.
...
1.  Consider each division of *long-ident* into [*namespace-or-module-path*].*ident*[.*rest*], in which the *namespace-or-module-path* becomes successively longer.

2.  For each such division, consider each module signature or namespace declaration group signature *F* in the list that is produced by resolving *namespace-or-module-path* by using *Name Resolution in Module and Namespace Paths*.

3.  For each such *F*, attempt to resolve *ident*[.*rest*] in the following order. If any resolution succeeds, then terminate the search:
...
1.  If the generic arity *n* is available, then look for a type that matches both *ident* and *n*.

2.  If no generic arity *n* is available, and *rest* is not empty:
...
6.  If *rest* is empty, return the type, otherwise resolve using *Name Resolution for Members*.
...
1.  A union case of *type*.

&nbsp;

7.  A property group of *type*.

8.  A method group of *type*.

9.  A field of *type*.

10. An event of *type*.

11. A property group of extension members of *type*, by consulting the *ExtensionsInScope* table.

12. A method group of extension members of *type*, by consulting the *ExtensionsInScope* table.

13. A nested type *type-nested* of *type*. Recursively resolve .*rest* if it is present, otherwise return *type-nested*.
...
1.  Divide *long-ident* into [*namespace-or-module-path*].*ident*[.*rest*], in which the *namespace-or-module-path* becomes successively longer.

&nbsp;

14. For each such division, consider each module and namespace declaration group *F* in the list that results from resolving *namespace-or-module-path* by using *Name Resolution in Module and Namespace Paths* (§14.1.2).

15. For each such *F*, attempt to resolve *ident*[.*rest*] in the following order. Terminate the search when the expression is successfully resolved.
...
1.  Check *expr* with the initial type *ty₁.*

&nbsp;

16. Process *projs* using *Expression-Qualified* against *ty₂*.

3. If the assertion fails, and *expr* has the form { *computation-expr* }:

1.  Check the expression as the computation expression form *f* { *computation-expr* }, giving result type *ty₁*.

&nbsp;

17. Process *projs* using *Expression-Qualified Lookup* against *ty₁*.
...
1.  Decompose arg into a list of arguments:
...
1.  If the method group contains a single method, the prospective unnamed argument types are one fresh type inference variable for each required, non-“out” parameter that the method accepts.

&nbsp;

4.  If the method group contains more than one method, the expected overall type of the expression is asserted to be a function type *dty* -> *rty*.

- If *dty* is a tuple type (*dty*1 * .. * *dty*N), the prospective argument types are (*dty*1, .. ,*dty*N).
...
1.  If the candidate method is generic and has been generalized, generate fresh type inference variables for its generic parameters. This results in the *FormalTypeArgs* for *M_(possible)*.

&nbsp;

19. Determine the *named* and *unnamed formal parameters*, called *NamedFormalArgs* and *UnnamedFormalArgs* respectively, by splitting the formal parameters for M into parameters that have a matching argument in *NamedActualArgs* and parameters that do not.

20. If the number of *UnnamedFormalArgs* exceeds the number of *UnnamedActualArgs*, then modify *UnnamedFormalArgs* as follows:
...
21. If the last element of *UnnamedFormalArgs* has the ParamArray attribute and type *pty*[] for some *pty*, then modify *UnnamedActualArgs* as follows:
...
22. Associate each *name*=*arg* in *NamedActualArgs* with a *target*. A target is a *named formal parameter*, a *settable return property*, or a *settable return field* as follows:
...
23. No prospective method call is generated if any of the following are true:
...
5. Attempt to apply initial types before argument checking. If only one prospective method call M_(possible) exists, *assert* M_(possible) by performing the following steps:

1.  Verify that each *ActualTypeArg_(i)* is equal to its corresponding *FormalTypeArg_(i)*.

&nbsp;

24. Verify that the type of *obj* is a subtype of the containing type of the method M.

25. For each *UnnamedActualArg_(i)* and *UnnamedFormalArg_(i)*, verify that the corresponding *ActualArgType* coerces to the type of the corresponding argument of M.

26. If M_(possible) uses ParamArray conversion with type *pty*, then for each *ParamArrayActualArg_(i)*, verify that the corresponding *ActualArgType* coerces to *pty*.

27. For each *NamedActualArg_(i)* that has an associated formal parameter target, verify that the corresponding *ActualArgType* coerces to the type of the corresponding argument of M.

28. For each *NamedActualArg_(i)* that has an associated property or field setter target, verify that the corresponding *ActualArgType* coerces to the type of the property or field.

29. Verify that the *prospective formal return type* coerces to the *expected actual return type*. If the method M has return type *rty*, the *formal return type* is defined as follows:

- If the prospective method call contains *ImplicitlyReturnedFormalArgs* with type ty₁, ..., ty_(N), the formal return type is *rty* * ty₁ * ... * ty_(N). If *rty* is unit then the formal return type is ty₁ * ... * ty_(N).

- Otherwise the formal return type is *rty*.

6. Check and elaborate argument expressions. If *arg* is present:

- Check and elaborate each unnamed actual argument expression *arg_(i)*. Use the corresponding type in *ActualArgTypes* as the initial type.

- Check and elaborate each named actual argument expression *arg_(i)*. Use the corresponding type in *ActualArgTypes* as the initial type.

7. Choose a unique M_(possible) according to the following rules:

- For each M_(possible), determine whether the method is *applicable* by attempting to assert M_(possible) as described in step 4a). If the actions in step 4a detect an inconsistent constraint set (§14.5), the method is not applicable. Regardless, the overall constraint set is left unchanged as a result of determining the applicability of each M_(possible).

- If a unique applicable M_(possible) exists, choose that method. Otherwise, choose the unique *best* M_(possible) by applying the following criteria, in order:
...
2)  Prefer candidates that do not use ParamArray conversion. If two candidates both use ParamArray conversion with types *pty₁* and *pty₂*, and *pty₁* feasibly subsumes *pty₂*, prefer the second; that is, use the candidate that has the more precise type.
...
5)  If two candidates have unnamed actual argument types *ty₁₁* ... *ty_(1n)* and *ty₂₁* ... *ty_(2n)*, and each *ty_(1i)* either

    1.  feasibly subsumes *ty_(2i)*, or

    2.  *ty_(2i)* is a System.Func type and *ty_(1i)* is some other delegate type,
...
1.  If the type of *obj* is a variable type or a value type, take the address of *obj* by using the *AddressOf*(*obj*, PossiblyMutates) operation (§6.9.4).

&nbsp;

30. Build the argument list by:
...
31. Bind *ImplicitlyReturnedFormalArgs* arguments by introducing mutable temporaries for each argument, passing them as byref parameters, and building a tuple from these mutable temporaries and any method return value as the overall result.

32. For each *NamedActualArgs* whose target is a settable property or field, assign the value into the property.

33. If *arg* is not present, return a function expression that represents a first class function value.
...
*ty*₁₁ ** ... * ty*_(1n) -> ... -> *ty*_(m1) ** ... * ty*_(mn) -> *rty*

- If the type does not decompose to this form, no flexibility is added.

- The positions *ty*_(ij) are called the “parameter positions” for the type. For each parameter position where *ty*_(ij) is not a sealed type, and is not a variable type, the type is replaced by a fresh type variable *ty'*_(ij) with a coercion constraint *ty'*_(ij) :> *ty*_(ij).
...
New equational constraints of the form *type*<*tyarg₁₁*,..., *tyarg_(1n)*> = *type*<*tyarg₂₁*,..., *tyarg_(2n)*> are reduced to a series of constraints *tyarg_(1i)* = *tyarg_(2i)* on identical named types and solved again.
...
New constraints in either of these two forms are reduced to the constraints *tyarg₁₁* = *tyarg₂₁ *... *tyarg_(1n) = tyarg_(2n)* and solved again:

*type*<*tyarg₁₁*,..., *tyarg_(1n)*> :> *type*<*tyarg₂₁*,..., *tyarg_(2n)*>
...
New constraints of the form *type₁*<*tyarg₁₁*,..., *tyarg_(1n)*> :> *type₂*<*tyarg₂₁*,..., *tyarg_(2n)*> where *type₁* and *type₂* are hierarchically related, are reduced to an equational constraint on two instantiations of *type₂ *according to the subtype relation between *type₁* and *type₂*, and solved again.
...
mutable*_(opt)* *pat* :*_(opt)* *type_(opt)* = *rhs-expr*
...
1. The pattern *pat* is checked against a fresh initial type *ty* (or *type* if such a type is present). This check results in zero or more identifiers *ident₁ ... ident_(m)*, each of type *ty₁ ... ty_(m)*.

2. The expression *rhs-expr* is checked against initial type *ty*, resulting in an elaborated form *expr*.

3. Each *ident_(i)* (of type *ty_(i)*) is then generalized (§14.6.7) and yields generic parameters <*typars_(j)*>.

4. The following rules are checked:

- All *ident_(j)* must be distinct.
...
new MenuItem(...) constructor might evaluate the callback as part of the construction process. However, because the System.Windows.Forms library is well designed, in this example this does not happen in practice, and so the warning can be suppressed or ignored by using compiler options.
...
The positions *ty*_(ij) are called the parameter positions for the type.

Condensation applies to a type parameter 'a if all of the following are true:

- 'a is not an explicit type parameter.

- 'a occurs at exactly one *ty*_(ij) parameter position.
...
- 'a does not occur in any other *ty*_(ij), nor in *rty*.
...
- A set of members override x.M(arg*₁*...arg*_(N)*).

- A set of additional interface types *ty₁* ... *ty_(n.)*

- A further set of members override x.M(*arg₁*...*arg_(N)*) for each *ty_(i)*.
...
- For each member x.M(*arg₁*...*arg_(N)*) in type *ty_(i)*, attempt to find a single dispatch slot in the form

abstract M : *aty₁*...*aty_(N)* -> *rty*

with name M, argument count N, and most-specific implementing type *ty_(i)*.
...
- The argument or return types of function expressions (fun … -> …).

- The signature or body of let-bound functions in expressions.

- Captured by the implementations of function expressions

- Captured by the member implementations of object expressions.
...
- Immediately after a <- token is encoutered when the subsequent token either (a) does not occur on the same line or (b) is one of *try*, *match*, *if*, *let*, *for*, *while* or *use*.
...
However, the block must not undent past other offside lines. Thefollowing is not permitted because the second line breaks the offside line established by the = in the first line:
...
The compilation context is augmented with a set of *type provider instances*. A type provider insance is interrogated for information through *type provider invocations* (TPI). Type provider invocations are all executed at compile-time. The type provider instance is not required at runtime.
...
- a type provider is a .NET 4.x binary component referenced as an imported asssembly reference. The assembly should have a TypeProviderAssemblyAttribute, with at least one component marked with TypeProviderAttribute.
...
type SomeService = CsvFile<const (_\_SOURCE_DIRECTORY__ + "/a.csv")>

Parentheses are needed around any simple contanst expressions after “const” that are not simple literal constants, e.g.
...
The following custom attributes are defined in some CLI implementations and may appear to be relevant to F#. However, they either do not affect the behavior of the F# compiler, or result in an error when used in in F# code.
...
See also the online documentation at [http://msdn.com/library/ee353567.aspx](http://msdn.microsoft.com/library/ee353567.aspx).
...
See [http://msdn.microsoft.com/library/ee370232.aspx](http://msdn.microsoft.com/en-us/library/ee370232.aspx)
...
See [http://msdn.microsoft.com/library/ee370357.aspx](http://msdn.microsoft.com/en-us/library/ee370357.aspx)

## Event Types

See [http://msdn.microsoft.com/library/ee370608.aspx](http://msdn.microsoft.com/en-us/library/ee370608.aspx)

## Immutable Collection Types (Map, Set)

See [http://msdn.microsoft.com/library/ee353413.aspx](http://msdn.microsoft.com/en-us/library/ee353413.aspx)

## Text Formatting (Printf) 

See [http://msdn.microsoft.com/library/ee370560.aspx](http://msdn.microsoft.com/en-us/library/ee370560.aspx)

## Reflection

See [http://msdn.microsoft.com/library/ee353491.aspx](http://msdn.microsoft.com/en-us/library/ee353491.aspx)

## Quotations

See [http://msdn.microsoft.com/library/ee370558.aspx](http://msdn.microsoft.com/en-us/library/ee370558.aspx)
...
Note that the for-expression form for *var* = *expr*₁ downto *expr*₂ do *expr*₃ is also permitted for ML compatibility.
...
2.  Namespace and Module Signatures

*namespace-decl-group-signature* : **namespace** *long-ident* *module-signature-elements*

*module-signature* : **module** *ident* = **begin_(opt)** *module-signature-body* **end_(opt)**
...
**begin_(opt)** *module-signature-element* ... *module-signature-element* **end_(opt)**
...
*attributes_(opt)* **access***_(opt)* **new** : *uncurried-sig*

*attributes_(opt)* **member** **access***_(opt)* *member-sig*

*attributes_(opt)* **abstract** **access***_(opt)* *member-sig*

*attributes_(opt)* **override** *member-sig*

*attributes_(opt)* **default** *member-sig*

*attributes_(opt)* **static** **member** **access***_(opt)* *member-sig*
...
*type-name* '=' '{' *record-fields* '}' *type-extension-elements-signature_(opt)*
...
**if** *expr* **then** *expr* *elif-branches_(opt)* *else-branch*_(opt)

**while** *expr* **do** *expr* done_(opt)

**for** *ident* = *expr* **to** *expr* **do** *expr* done_(opt)

**for** *pat* **in** *expr*-*or-range-expr* **do** *expr* done_(opt)
...
*interface-impl* : **interface** *type* *object-members_(opt)*
...
**for** *ident* = *expr* **to** *expr* **do** *comp-expr* done_(opt)

**for** *pat* **in** *expr*-*or-range-expr* **do** *comp-expr* done_(opt)

*comp-expr*; *comp-expr*

*expr*

*comp-rule* : *pat* *pattern-guard_(opt)* -> *comp*-*expr*

*comp-rules* : '|'*_(opt)* *comp*-*rule* '|' ... '|' *comp*-*rule*
...
7.  AddressOf Operators

&*expr*

&&*expr*

8.  Lookup Expressions
...
*long-ident* *pat-param_(opt)* *pat_(opt)*
...
*type-name* : *attributes_(opt) access_(opt) ident* *typar-defns*_(opt)

*abbrev-type-defn* : *type-name* = *type*

*union-type-defn* : *type-name* '=' *union-type-cases type-extension-elements_(opt)*

*union-type-cases* : '|'*opt* *union-type-case* '|' ... '|' *union-type-case*

*union-type-case* : *attributes_(opt) union-type-case-data*
...
*record-type-defn* : *type-name* *=* '{' *record-fields* '}' *type-extension-elements_(opt)*

*record-fields* : *record-field* ; ... ; *record-field* ;*_(opt)*

*record-field* : *attributes_(opt)* **mutable***_(opt)* *access_(opt)* *ident* : *type*
...
**begin_(opt)** *class-inherits-decl_(opt) class-function-or-value-defns_(opt) type-defn-elements_(opt)***end_(opt)**
...
*attributes_(opt)* **exception** *union-type-case-data*

*attributes_(opt)* **exception** *ident* = *long-ident*

*enum-type-defn* : *type-name '*=' *enum-type-cases*

*enum-type-cases* : '|'*_(opt)* *enum-type-case* '|' ... '|' *enum-type-case*
...
*primary-constr-args* : *attributes_(opt)* *access_(opt)* (*simple-pat, ... , simplepat*)
...
*attributes_(opt)* **static***_(opt)* **member** *access_(opt)* *method-or-prop-defn*

*attributes_(opt)* **abstract** **member***_(opt)* *access_(opt)* *member-sig*

*attributes_(opt)* **override** *access_(opt)* *method-or-prop-defn*

*attributes_(opt)* **default** *access_(opt)* *method-or-prop-defn*

*attributes_(opt)* **static***_(opt)* **val** **mutable***_(opt)* *access_(opt)* *ident* *: type*

*additional-constr-defn*

*method-or-prop-defn* :

*ident_(opt)* *function-defn*

*ident_(opt) value-defn*

*ident_(opt) ident* **with** *function-or-value-defns*
...
*arg-spec* : *attributes_(opt)* *arg-name-spec_(opt) type*

*arg-name-spec* : ?*_(opt)* *ident* :
...
**static***_(opt)* **member** *ident*.*_(opt)* *ident* *pat1* ... *patn* = *expr*
...
7.  Custom Attributes and Reflection
...
A simplified, indentation-aware syntax in which lines of code that form a sequence of declarations are aligned on the same column, and the *in* and ;; separators can be omitted. Lightweight syntax is the default for all F# code in files with extension .fs, .fsx, .fsi and .fsscript.
...
A description of the contents of a module that the F# compiler generates during type inference. The module signature describes the externally visible elements of the module.
...
Lines that occur at column positions in lightweight syntax. Offside lines are introduced by other structured constructs, such asthe = token associated with let, and the first token after **then** in an **if/then/else** construct.
...
An object of type System.Type that is the runtime representation of some or all of the information carried in type definitions and static types. The runtime type associated with an objects is accessed by using the obj.GetType() method, which is available on all F# values.
...
An expression that represents the sequential execution of one statement followed by another. The expression has the form *expr*₁; *expr*₂.
